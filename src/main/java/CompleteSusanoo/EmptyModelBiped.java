...
public class EmptyModelBiped extends ModelBiped {
  ...
  public EmptyModelBiped() {
    this(0.0F);
  }
  
  public EmptyModelBiped(float p_i1148_1_) {
    this(p_i1148_1_, 0.0F, 64, 32);
  }
  
  public EmptyModelBiped(float p_i1149_1_, float p_i1149_2_, int p_i1149_3_, int p_i1149_4_) {

...
public class EntityCompleteSusanoo extends EntityLiving {
  public EntityLivingBase jutsusha;
  
  private boolean disableDamage;
  
  public EntityCompleteSusanoo(World par1World) {
    super(par1World);
  ...
  public EntityCompleteSusanoo(World par1World, EntityLivingBase par2Entity) {
    super(par1World);

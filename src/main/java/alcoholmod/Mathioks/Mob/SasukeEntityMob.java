...
public class SasukeEntityMob extends EntityTameable {
  ...
  public SasukeEntityMob(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(0.6F, 1.8F);
  ...
  public void onUpdate() {
    ...
    if (getOwner() != null) {
      ...
      if (this.TalkInt == 10) {
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : You cannot grant me the power I seek!"));
        this.TalkInt = 0;
      } 
      if (this.TalkInt == 11) {
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : You think I'd join a Chunin?!"));
        this.TalkInt = 0;
      } 
      if (this.TalkInt == 12) {
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : I'll show you true loneliness if you don't leave me now!"));
        this.TalkInt = 0;
      } 
      if (this.TalkInt == 13) {
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : I don't know what powers you posses to have beaten me,"));
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : But don't think I'll join you on your little D-rank missions..."));
        this.TalkInt = 0;
      } 
      if (this.TalkInt == 14) {
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : hmpf.. Fine.. I'll help you out for now.."));
        this.TalkInt = 0;
      } 
      if (this.TalkInt == 1) {
      ...
      if (this.TalkInt == 2) {
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : Lightning Style: Lightning Ball Jutsu!"));
        this.TalkInt = 0;
      } 
      if (this.TalkInt == 3) {
      ...
      if (this.TalkInt == 4) {
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : Inferno Style: Great Fireball Jutsu!"));
        this.TalkInt = 0;
      } 
      if (isSitting() && this.SittingTalk)
        if (!this.Invul) {
          Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : Alright, I'll follow you!"));
          this.SittingTalk = false;
        } else {
          Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : Can't you see I'm still healing?!"));
          this.SittingTalk = false;
        }  
      if (!isSitting() && this.SittingTalk) {
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : Good, I'll stay here!"));
        this.SittingTalk = false;
      } 
      if (this.FirstTamed) {
      ...
      if (getAttackTarget() != null) {
        ...
        if (randomNumberSay == 1) {
          ...
          if (randomNumber == 0)
            Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : Come over here " + getAttackTarget().getCommandSenderName() + "!")); 
          if (randomNumber == 1)
            Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : " + getAttackTarget().getCommandSenderName() + "!! I'll get you!")); 
          if (randomNumber == 2)
            Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : Hey " + getAttackTarget().getCommandSenderName() + " I'm your enemy!!")); 
          if (randomNumber == 3)
            Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : " + getAttackTarget().getCommandSenderName() + " my eyes can see your every move!")); 
          if (randomNumber == 4)
            Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : " + getAttackTarget().getCommandSenderName() + " don't underestimate the Uchiha!!")); 
          if (randomNumber == 5)
            Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : " + getAttackTarget().getCommandSenderName() + " feel my hatred!!")); 
          if (randomNumber == 6)
            Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : " + getAttackTarget().getCommandSenderName() + " this is the power of the Uchiha!!")); 
          if (randomNumber == 7)
            Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : Hey " + getOwner().getCommandSenderName() + " let's get this guy!")); 
        } 
      } 
    } 
  ...
  protected void onDeathUpdate() {
    if (getOwner() != null && !this.worldObj.isRemote) {
      ...
      if (randomNumber == 1)
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : aaAAARGH!! " + getOwner().getCommandSenderName() + " It's up to you!")); 
      if (randomNumber == 2)
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : AAAaaAAaARGH")); 
      if (randomNumber == 3)
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : I'll get my revenge!!")); 
      if (randomNumber == 0)
        Entity.addChatComponentMessage((IChatComponent)new ChatComponentText("Sasuke : Hey " + getOwner().getCommandSenderName() + " Don't fail now will ya?!")); 
    } 
    setHealth(10.0F);
    this.Invul = true;
  }

...
public class EntityRPMob1 extends EntityTameable {
  ...
  public EntityRPMob1(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(0.6F, 2.1F);
  ...
  protected String getLivingSound() {
    return isAngry() ? "tm:FrankyLaughing" : ((this.rand.nextInt(3) == 0) ? ((isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0F) ? "tm:FrankyIfHealthIsLow" : "tm:FrankySuper") : "tm:FrankyLaughing");
  }
  ...
  public boolean interact(EntityPlayer p_70085_1_) {
    ...
    if (isTamed()) {
      if (itemstack != null)
        if (itemstack.getItem() instanceof ItemFood) {
          ...
          if (itemfood.isWolfsFavoriteMeat() && this.dataWatcher.getWatchableObjectFloat(18) < 400.0F) {
    ...
    } else if (itemstack != null && itemstack.getItem() == Items.iron_ingot && !isAngry()) {
      if (!p_70085_1_.capabilities.isCreativeMode)
        itemstack.stackSize--; 
      if (itemstack.stackSize <= 0)
        p_70085_1_.inventory.setInventorySlotContents(p_70085_1_.inventory.currentItem, (ItemStack)null); 

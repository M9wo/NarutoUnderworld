...
public class EntityRPMob2 extends EntityTameable {
  ...
  public EntityRPMob2(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(0.6F, 2.1F);
  ...
  protected String getLivingSound() {
    return isAngry() ? "tm:BrookLaugh" : ((this.rand.nextInt(3) == 0) ? ((isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0F) ? "tm:BrookYoHoHo" : "tm:brookViolin") : "tm:BrookLaugh");
  }
  
  protected String getHurtSound() {
    return "tm:BrookAttackAngry";
  }
  
  protected String getDeathSound() {
    return "tm:BrookDeath";
  }

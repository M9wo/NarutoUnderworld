...
public class EntityRPMob6 extends EntityTameable {
  ...
  public EntityRPMob6(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(0.6F, 1.8F);
  ...
  protected String getLivingSound() {
    return isAngry() ? "tm:Zoro3Swords" : ((this.rand.nextInt(3) == 0) ? ((isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0F) ? "tm:ZoroNotFail" : "tm:ZoroGoodStuff") : "tm:ZoroLaughing");
  }

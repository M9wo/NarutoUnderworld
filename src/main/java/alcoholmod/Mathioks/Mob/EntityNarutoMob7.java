...
public class EntityNarutoMob7 extends EntityTameable {
  ...
  public EntityNarutoMob7(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(0.6F, 1.8F);
  ...
  public boolean interact(EntityPlayer p_70085_1_) {
    ...
    } else if (itemstack != null && itemstack.getItem() == Items.glowstone_dust && !isAngry()) {
      if (!p_70085_1_.capabilities.isCreativeMode)
        itemstack.stackSize--; 
      if (itemstack.stackSize <= 0)
        p_70085_1_.inventory.setInventorySlotContents(p_70085_1_.inventory.currentItem, (ItemStack)null); 

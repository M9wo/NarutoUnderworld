...
public class EntityNarutoMob08 extends EntityTameable {
  ...
  public EntityNarutoMob08(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(0.6F, 1.8F);
    ...
    if (isTamed()) {
      if (itemstack != null)
        if (itemstack.getItem() instanceof ItemFood) {
          ...
          if (itemfood.isWolfsFavoriteMeat() && this.dataWatcher.getWatchableObjectFloat(18) < 550.0F) {

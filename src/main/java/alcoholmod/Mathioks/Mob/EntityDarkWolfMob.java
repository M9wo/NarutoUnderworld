...
public class EntityDarkWolfMob extends EntityTameable {
  ...
  public EntityDarkWolfMob(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(0.9F, 1.2F);
    ...
    if (isTamed()) {
      if (itemstack != null)
        if (itemstack.getItem() instanceof ItemFood) {
          ...
          if (itemfood.isWolfsFavoriteMeat() && this.dataWatcher.getWatchableObjectFloat(18) < 300.0F) {

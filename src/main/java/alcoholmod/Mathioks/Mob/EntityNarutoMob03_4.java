...
public class EntityNarutoMob03_4 extends EntityTameable {
  ...
  public EntityNarutoMob03_4(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(0.6F, 1.8F);
  ...
  protected String getLivingSound() {
    return (this.rand.nextInt(3) == 0) ? "" : ((isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0F) ? "" : (isAngry() ? "" : ""));
  }
  ...
  public void onUpdate() {
    ...
    if (this.ticksExisted >= 3600)
      setDead(); 
    if (getHealth() > 0.0F && getHealth() < getMaxHealth() && this.regenTimer == 0) {
      heal(1.0F);
      this.regenTimer = 30;
    } 
    if (func_70922_bv()) {
  ...
  public float getInterestedAngle(float p_70917_1_) {
    return (this.field_70924_f + (this.field_70926_e - this.field_70924_f) * p_70917_1_) * 0.15F * 3.141593F;
  }
  ...
  public float getTailRotation() {
    return isTamed() ? ((0.55F - (20.0F - this.dataWatcher.getWatchableObjectFloat(18)) * 0.02F) * 3.141593F) : (isAngry() ? 1.53938F : 0.6283186F);
  }

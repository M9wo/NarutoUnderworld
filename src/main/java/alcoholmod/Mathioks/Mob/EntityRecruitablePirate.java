...
public class EntityRecruitablePirate extends EntityTameable {
  ...
  public EntityRecruitablePirate(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(3.0F, 9.0F);
  ...
  public boolean interact(EntityPlayer p_70085_1_) {
    ...
    if (isTamed()) {
      if (itemstack != null)
        if (itemstack.getItem() instanceof ItemFood) {
          ...
          if (itemfood.isWolfsFavoriteMeat() && this.dataWatcher.getWatchableObjectFloat(18) < 100.0F) {
    ...
    } else if (itemstack != null && itemstack.getItem() == Items.gold_ingot && !isAngry()) {
      if (!p_70085_1_.capabilities.isCreativeMode)
        itemstack.stackSize--; 
      if (itemstack.stackSize <= 0)
        p_70085_1_.inventory.setInventorySlotContents(p_70085_1_.inventory.currentItem, (ItemStack)null); 

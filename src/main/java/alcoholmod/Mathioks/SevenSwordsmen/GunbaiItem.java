...
public class GunbaiItem extends ItemSword {
  boolean isUsing;
  
  public GunbaiItem(Item.ToolMaterial mat) {
    super(mat);
    setFull3D();
    setUnlocalizedName("Gunbaii");
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    par3List.add(EnumChatFormatting.DARK_AQUA + "A Legendary weapon");
    par3List.add(EnumChatFormatting.DARK_AQUA + "wielded by many great Shinobi");

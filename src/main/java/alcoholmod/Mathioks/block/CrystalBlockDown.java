...
public class CrystalBlockDown extends BlockFalling {
  ...
  public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
    if (p_149674_1_.isAirBlock(p_149674_2_, p_149674_3_ + 1, p_149674_4_)) {
      ...
      if (l < 3) {
        ...
        if (i1 == 15) {
          p_149674_1_.setBlock(p_149674_2_, p_149674_3_ + 1, p_149674_4_, (Block)this);
          p_149674_1_.setBlockMetadataWithNotify(p_149674_2_, p_149674_3_, p_149674_4_, 0, 4);
          onNeighborBlockChange(p_149674_1_, p_149674_2_, p_149674_3_ + 1, p_149674_4_, (Block)this);
        } else {
  ...
  public boolean canBlockStay(World p_149718_1_, int p_149718_2_, int p_149718_3_, int p_149718_4_) {
    ...
    return (block == Blockss.crystalBlockLowest || block == Blockss.crystalBlockDown || block == Blockss.crystalTopBlock);
  }
  ...
  public void registerBlockIcons(IIconRegister p_149651_1_) {
    this.blockIcon = p_149651_1_.registerIcon("tm:CrystalBottom");
    this.field_150041_a = p_149651_1_.registerIcon("tm:BoneEmpty");
    this.field_150040_b = p_149651_1_.registerIcon("tm:CrystalLowestTop");
  }
}

...
public class BloodPrisonFence extends Block {
  ...
  protected BloodPrisonFence() {
    super(Material.iron);
    setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
    setBlockTextureName("tm:BloodPrisonBlock");
    setHardness(200.0F);
    setResistance(100.0F);
    setBlockName("BloodPrisonFence");
  }
  ...
  public void onEntityCollidedWithBlock(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity p_149670_5_) {
    ...
    if (p_149670_5_ instanceof EntityLivingBase) {
      ((EntityLivingBase)p_149670_5_).addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 10, -150));

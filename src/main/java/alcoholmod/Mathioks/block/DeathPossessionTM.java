...
public class DeathPossessionTM extends Block {
  private static final String __OBFID = "CL_00000309";
  
  protected DeathPossessionTM() {
    super(Material.web);
    setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 0.125F, 1.0F);
    setBlockTextureName("tm:DeathPossessionTM");
    setBlockName("DeathPossessionTM");
    setHardness(10.0F);
  ...
  public void registerBlockIcons(IIconRegister p_149651_1_) {
    this.blockIcon = p_149651_1_.registerIcon("tm:DeathPossessionTM");
  }

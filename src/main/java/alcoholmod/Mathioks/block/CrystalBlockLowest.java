...
public class CrystalBlockLowest extends Block {
  ...
  public void registerBlockIcons(IIconRegister p_149651_1_) {
    this.blockIcon = p_149651_1_.registerIcon("tm:CrystalLowest");
    this.field_150041_a = p_149651_1_.registerIcon("tm:CrystalLowestTop");

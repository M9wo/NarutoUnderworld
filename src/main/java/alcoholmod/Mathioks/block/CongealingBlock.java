...
public class CongealingBlock extends Block {
  private static final String __OBFID = "CL_00000309";
  
  private int counter = 0;
  
  protected CongealingBlock() {
    super(Material.iron);
    setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 0.125F, 1.0F);
    setTickRandomly(true);
    setBlockTextureName("tm:Congealing");
    setBlockName("Congealing");
    setHardness(10.0F);
  ...
  public void registerBlockIcons(IIconRegister p_149651_1_) {
    this.blockIcon = p_149651_1_.registerIcon("tm:Congealing");
  }

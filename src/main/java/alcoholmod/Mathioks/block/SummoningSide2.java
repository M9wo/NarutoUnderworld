...
public class SummoningSide2 extends Block {
  private static final String __OBFID = "CL_00000309";
  
  protected SummoningSide2() {
    super(Material.web);
    setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 0.125F, 1.0F);
    setBlockTextureName("tm:SummoningSide2");
    setBlockName("SummoningSide2");
    setHardness(10.0F);
  ...
  public void registerBlockIcons(IIconRegister p_149651_1_) {
    this.blockIcon = p_149651_1_.registerIcon("tm:SummoningSide2");
  }

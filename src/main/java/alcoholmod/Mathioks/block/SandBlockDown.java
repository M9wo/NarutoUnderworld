...
public class SandBlockDown extends Block implements IPlantable {
  ...
  public boolean canBlockStay(World p_149718_1_, int p_149718_2_, int p_149718_3_, int p_149718_4_) {
    ...
    return (block == Blocks.sand || block == Blockss.blockSandDown || block == Blockss.blockSandTop);
  }
  ...
  public void registerBlockIcons(IIconRegister p_149651_1_) {
    this.blockIcon = p_149651_1_.registerIcon("tm:SandBottom");
    this.field_150041_a = p_149651_1_.registerIcon("tm:boneEmpty");
    this.field_150040_b = p_149651_1_.registerIcon("tm:SandLowestTop");
  }

...
public class ItemChidori extends JutsuItem {
          ...
          for (int k2 = 0; k2 < list.size(); k2++) {
            if (!par2World.isRemote) {
              ...
              if (entity instanceof net.minecraft.entity.EntityLiving && entity instanceof EntityLivingBase) {
                ...
                entity.attackEntityFrom(DamageSource.causePlayerDamage(player), 75.0F);
              } 
              if (entity instanceof EntityPlayer && !entity.getUniqueID().toString().equals(user)) {
                ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 100, 2));
                ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(Potion.jump.id, 100, -1));
        ...
        if (counter == 0) {
          ...
          if (!Par2World.isRemote) {
            ...
            if (props.getCurrentMana() >= 100) {
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Chidori!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "A high concentration of lightning");
    par3List.add(EnumChatFormatting.DARK_AQUA + "chakra around the user's hand");
    par3List.add(EnumChatFormatting.DARK_AQUA + "Increases speed, damages and paralyzes");
    par3List.add(EnumChatFormatting.DARK_AQUA + "Anything on your path");
    par3List.add(EnumChatFormatting.DARK_RED + "Chakra Cost: " + 'd');
    par3List.add(EnumChatFormatting.DARK_RED + "Damage: " + 'K');
  }
}

...
public class FuhmaShurikenEntity extends EntityArrow {
  ...
  private double damage = 1.75D;
  
  private int knockbackStrength;
  
  private static final String __OBFID = "CL_00001715";
  
  public FuhmaShurikenEntity(World par1World) {
    super(par1World);
  }
  
  public FuhmaShurikenEntity(World par1World, double par2, double par4, double par6) {
    super(par1World, par2, par4, par6);
  }
  
  public FuhmaShurikenEntity(World par1World, EntityLivingBase par2EntityLiving, EntityLivingBase par3EntityLiving, float par4, float par5) {
    super(par1World, par2EntityLiving, par3EntityLiving, par4, par5);
  }
  
  public FuhmaShurikenEntity(World par1World, EntityLivingBase par2EntityLiving, float par3) {

...
public class KunaiRender extends RenderArrow {
  private static final ResourceLocation batTextures = new ResourceLocation("tm:textures/entity/Kunai2.png");
  
  private static final ResourceLocation cowTextures = new ResourceLocation("tm:textures/entity/Crystaldragon.png");
  
  public void renderKunai(KunaiEntity par1EntityArrow, double par2, double par4, double par6, float par8, float par9) {
  ...
  public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
    renderKunai((KunaiEntity)par1Entity, par2, par4, par6, par8, par9);
  }

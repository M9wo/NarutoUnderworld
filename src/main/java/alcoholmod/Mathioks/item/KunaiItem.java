...
public class KunaiItem extends ItemSword {
  public KunaiItem(Item.ToolMaterial mat) {
    super(mat);
  ...
  public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
    ...
    if (props.getShurikenjutsu() >= 10.0D) {
      ...
      KunaiEntity kunai = new KunaiEntity(par2World, (EntityLivingBase)par3EntityPlayer, 2.0F);
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    par3List.add(EnumChatFormatting.DARK_AQUA + "Kunai, a weapon that utilizes");

...
public class KunaiBombEntity extends EntityArrow {
  ...
  public KunaiBombEntity(World par1World) {
    super(par1World);
  }
  
  public KunaiBombEntity(World par1World, double par2, double par4, double par6) {
    super(par1World, par2, par4, par6);
  }
  
  public KunaiBombEntity(World par1World, EntityLivingBase par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5) {
    super(par1World, par2EntityLiving, (EntityLivingBase)par3EntityLiving, par4, par5);
  }
  
  public KunaiBombEntity(World par1World, EntityLivingBase par2EntityLiving, float par3) {
      ...
      if (block == this.field_145790_g && j == this.inData) {
        ...
        if (this.ticksInGround >= 100)
          if (this.shootingEntity == null) {
            this.worldObj.newExplosion((Entity)this, this.posX, this.posY, this.posZ, 2.0F, false, false);
          } else {
            this.worldObj.newExplosion(this.shootingEntity, this.posX, this.posY, this.posZ, 2.0F, false, false);
          }  
        if (this.ticksInGround == 103)
          setDead(); 
      } else {
        this.inGround = false;

...
public class SkillLearnerScorchRelease extends Item {
  ...
  public SkillLearnerScorchRelease() {
    setMaxDamage(500);
    this.maxStackSize = 1;
  }
        ...
        if (!Par3EntityPlayer.capabilities.isCreativeMode) {
          ...
          if (EmptySpaces > 0) {
            if (props.getJutsuPoints() >= 20 && Par1ItemStack.getItemDamage() == 0) {
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.ScorchReleaseSetup));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Scorch Release: Ring of Suns!"));
              ...
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.ScorchReleaseExtremelySteamingMurder));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Scorch Release: Extremely Steaming Murder!"));
              ...
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.ScorchReleaseMultipleFallingSuns));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Scorch Release: Multiple Falling Suns!"));
              ...
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.ScorchReleaseHeath));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Scorch Release: Suns Heath Vortex Meadow!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    if (par1ItemStack.getItemDamage() == 0) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Scorch Release: Ring of Suns");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 20 JP");
    } 
    if (par1ItemStack.getItemDamage() == 100) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Scorch Release: Extremely Steaming Murder");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 30 JP");
    } 
    if (par1ItemStack.getItemDamage() == 200) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Scorch Release: Multiple Falling Suns");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 40 JP");
    } 
    if (par1ItemStack.getItemDamage() == 300) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Scorch Release: Suns Heath Vortex Meadow");

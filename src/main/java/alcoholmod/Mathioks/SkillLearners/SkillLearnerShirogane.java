...
public class SkillLearnerShirogane extends Item {
        ...
        if (!Par3EntityPlayer.capabilities.isCreativeMode) {
          ...
          if (EmptySpaces > 0) {
            if (props.getJutsuPoints() >= 15 && Par1ItemStack.getItemDamage() == 0) {
              ...
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.PuppetControl1));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Puppet Control"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    if (par1ItemStack.getItemDamage() == 300) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Puppet Control");

...
public class SkillLearnerSarutobi extends Item {
        ...
        if (!Par3EntityPlayer.capabilities.isCreativeMode) {
          ...
          if (EmptySpaces > 0) {
            if (props.getJutsuPoints() >= 25 && Par1ItemStack.getItemDamage() == 0) {
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.SarutobiAsh));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Sarutobi: Ash Pile Burning!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    if (par1ItemStack.getItemDamage() == 0) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Sarutobi: Ash Pile Burning");
    ...
    if (par1ItemStack.getItemDamage() == 100) {
      ...
      par3List.add(EnumChatFormatting.GOLD + "Learn Sarutobi: Great Flame Technique");

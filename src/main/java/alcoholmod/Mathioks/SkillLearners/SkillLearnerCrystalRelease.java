...
public class SkillLearnerCrystalRelease extends Item {
  ...
  public SkillLearnerCrystalRelease() {
    setMaxDamage(500);
    this.maxStackSize = 1;
  }
        ...
        if (!Par3EntityPlayer.capabilities.isCreativeMode) {
          ...
          if (EmptySpaces > 0) {
            if (props.getJutsuPoints() >= 30 && Par1ItemStack.getItemDamage() == 0) {
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.ItemCrystalBlade));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Crystal Release: Jade Crystal Blade!"));
              ...
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.CrystalReleaseCrystalNeedles));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Crystal Release: Crystal Needles!"));
              ...
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.CrystalReleaseCrystalArmor));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Crystal Release: Crystal Armour!"));
              ...
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.CrystalDragonItem));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Crystal Release: Tearing Crystal Falling Dragon!"));
              props.setJutsuPoints(props.getJutsuPoints() - 50);
              PacketDispatcher.sendTo((IMessage)new SyncJutsuPointsMessage(Par3EntityPlayer), (EntityPlayerMP)Par3EntityPlayer);
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    if (par1ItemStack.getItemDamage() == 0) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Crystal Release: Jade Crystal Blade");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 30 JP");
    } 
    if (par1ItemStack.getItemDamage() == 100) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Crystal Release: Crystal Needles");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 40 JP");
    } 
    if (par1ItemStack.getItemDamage() == 200) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Crystal Release: Crystal Armour");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 50 JP");
    } 
    if (par1ItemStack.getItemDamage() == 300) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Crystal Release: Tearing Crystal Falling Dragon");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 50 JP");
    } 

...
public class SkillLearnerAkimichi extends Item {
        ...
        if (!Par3EntityPlayer.capabilities.isCreativeMode) {
          ...
          if (EmptySpaces > 0) {
            if (props.getJutsuPoints() >= 15 && Par1ItemStack.getItemDamage() == 0) {
              ...
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Akimichi: Partial Multi-Size Technique!"));
              ...
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Akimichi: Human Bullet Tank!"));
              ...
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Akimichi: Butterfly Mode!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    if (par1ItemStack.getItemDamage() == 0) {
      ...
      par3List.add(EnumChatFormatting.GOLD + "Learn Akimichi: Super Open Hand Slap");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 15 JP");
    } 
    if (par1ItemStack.getItemDamage() == 100) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Akimichi: Partial Multi-Size Technique");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 15 JP");
    } 
    if (par1ItemStack.getItemDamage() == 200) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Akimichi: Human Bullet Tank");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 25 JP");
    } 
    if (par1ItemStack.getItemDamage() == 300) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Akimichi: Butterfly Mode");

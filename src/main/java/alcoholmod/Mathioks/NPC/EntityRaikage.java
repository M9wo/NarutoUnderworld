...
public class EntityRaikage extends EntityKage implements IRangedAttackMob {
  ...
  public EntityRaikage(World par1World) {
    super(par1World);
  ...
  public boolean interact(EntityPlayer p_70085_1_) {
    ...
    if (p_70085_1_ != null) {
      ...
      if (props.getAffiliation() == 1 && props.getRank() == 13 && !this.worldObj.isRemote) {
        p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Raikage: How dare you show your face here Akatsuki!!"));
        attackEntityAsMob((Entity)p_70085_1_);
      } 
      if (props.getAffiliation() == 1 && props.getRank() == 14 && !this.worldObj.isRemote) {
        p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Raikage: An Akatsuki Leader.. Let me take care of you!!"));
        attackEntityAsMob((Entity)p_70085_1_);
      } 
      if (props.getLevel() < 50 && props.getRank() == 21) {
        if (props.getAffiliation() == 16 && !this.worldObj.isRemote)
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Raikage: Welcome to the village Academy Student")); 
        if (props.getAffiliation() == 16 && this.giveCounter == 0) {
          ...
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Raikage: What is your business in the Hidden Cloud?"));
        } 
      } 
      if (props.getLevel() >= 50 && props.getRank() == 21)
        if (props.getAffiliation() == 16) {
          if (!this.worldObj.isRemote)
            p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Raikage: Are you ready to take the Genin Exams?")); 
        } else if (!this.worldObj.isRemote) {
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Raikage: What is your business in the Hidden Cloud?"));
        }  
      if (props.getLevel() >= 50 && props.getRank() == 21) {

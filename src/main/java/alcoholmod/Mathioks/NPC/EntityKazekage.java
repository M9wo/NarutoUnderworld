...
public class EntityKazekage extends EntityKage implements IRangedAttackMob {
  ...
  public EntityKazekage(World par1World) {
    super(par1World);
  ...
  public boolean interact(EntityPlayer p_70085_1_) {
    ...
    if (p_70085_1_ != null) {
      ...
      if (props.getAffiliation() == 1 && props.getRank() == 13 && !this.worldObj.isRemote) {
        p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: How dare you show your face here Akatsuki!!"));
        attackEntityAsMob((Entity)p_70085_1_);
      } 
      if (props.getAffiliation() == 1 && props.getRank() == 14 && !this.worldObj.isRemote) {
        p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: An Akatsuki Leader.. Let me take care of you!!"));
        attackEntityAsMob((Entity)p_70085_1_);
      } 
      if (props.getLevel() < 50 && props.getRank() == 21) {
        if (props.getAffiliation() == 16 && !this.worldObj.isRemote)
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: Welcome to the village Academy Student")); 
        if (props.getAffiliation() == 16 && this.giveCounter == 0) {
          if (!this.worldObj.isRemote) {
            p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("please take this armor as a gift from your Kazekage"));
            dropItem(AlcoholMod.chestplategaara, 1);
            dropItem(AlcoholMod.bootsgaara, 1);
            dropItem(AlcoholMod.legsgaara, 1);
            this.giveCounter = 30000;
          } 
        } else if (!this.worldObj.isRemote) {
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: What is your business in the Hidden Sand?"));
        } 
      } 
      if (props.getLevel() >= 50 && props.getRank() == 21)
        if (props.getAffiliation() == 16) {
          if (!this.worldObj.isRemote)
            p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: Are you ready to take the Genin Exams?")); 
        } else if (!this.worldObj.isRemote) {
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: What is your business in the Hidden Sand?"));
        }  
      if (props.getLevel() >= 200 && props.getRank() == 1)
        if (props.getAffiliation() == 16) {
          if (!this.worldObj.isRemote)
            p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: Are you ready to take the Chunin Exams?")); 
        } else if (!this.worldObj.isRemote) {
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: What is your business in the Hidden Sand?"));
        }  
      if (props.getLevel() >= 350 && props.getRank() == 2)
        if (props.getAffiliation() == 16) {
          if (!this.worldObj.isRemote)
            p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: Are you ready to take the Tokubetsu Jonin Exams?")); 
        } else if (!this.worldObj.isRemote) {
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: What is your business in the Hidden Sand?"));
        }  
      if (props.getLevel() >= 600 && props.getRank() == 3)
        if (props.getAffiliation() == 16) {
          if (!this.worldObj.isRemote)
            p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: Are you ready to take the Jonin Exams?")); 
        } else if (!this.worldObj.isRemote) {
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: What is your business in the Hidden Sand?"));
        }  
      if (props.getLevel() >= 800 && props.getRank() == 4)
        if (props.getAffiliation() == 16) {
          if (!this.worldObj.isRemote) {
            p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: Because of your outstanding achievements"));
      ...
      if (props.getLevel() >= 1100 && props.getRank() == 5)
        if (props.getAffiliation() == 16) {
          if (!this.worldObj.isRemote) {
            p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: Your achievements in the Anbu has made us"));
      ...
      if (props.getLevel() >= 1100 && props.getRank() == 6)
        if (props.getAffiliation() == 16) {
          if (!this.worldObj.isRemote) {
            p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: Your achievements in the Medical team has made"));
      ...
      if (props.getLevel() >= 1100 && props.getRank() == 7)
        if (props.getAffiliation() == 16) {
          if (!this.worldObj.isRemote) {
            p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: Your achievements in the Intel department has"));
      ...
      if ((props.getLevel() >= 1500 && props.getRank() == 8) || props.getRank() == 9 || props.getRank() == 10)
        if (props.getAffiliation() == 16) {
          if (!this.worldObj.isRemote) {
            p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: Your growth from an academy student up till"));
            ...
            p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("I will gladly bestow upon you the title of hokage!"));
          } 
        } else if (!this.worldObj.isRemote) {
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: What is your business in the Hidden Sand?"));
        }  
      if ((props.getLevel() < 1200 || props.getAffiliation() != 16 || props.getRank() != 8) && props.getRank() != 9 && props.getRank() != 10) {
        if (!this.worldObj.isRemote)
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: What is your business in the Hidden Sand?")); 
      } else if (props.getexplosionRelease() == 1) {
        if (!this.worldObj.isRemote) {
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: As you own the rare Explosion Release"));
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kekkei Genkai, we'd like to invite you to the"));
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Sunagakure Explosion Corps."));
        } 
      } else if (!this.worldObj.isRemote) {
        p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("Kazekage: What is your business in the Hidden Sand?"));
      } 

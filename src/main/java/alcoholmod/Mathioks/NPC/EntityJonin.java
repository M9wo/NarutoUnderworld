...
public class EntityJonin extends EntityNinja implements IRangedAttackMob {
  ...
  public EntityJonin(World par1World) {
    super(par1World);
    ...
    this.targetTasks.addTask(5, (EntityAIBase)new EntityAINearestAttackableTarget(this, EntityPlayer.class, 0, true));
    this.targetTasks.addTask(9, (EntityAIBase)new EntityAINearestAttackableTarget(this, EntityTameable.class, 0, true));
    ...
    if (rand == 1)
      setCurrentItemOrArmor(0, new ItemStack(AddedItems.KatanaEmerald)); 
    if (rand == 2)
      setCurrentItemOrArmor(0, new ItemStack(AddedItems.SNDKatana2)); 
    if (rand == 3)
      setCurrentItemOrArmor(0, new ItemStack(AlcoholMod.ShurikenItem)); 
    if (rand == 4)
      setCurrentItemOrArmor(0, new ItemStack(AddedItems.Katana7)); 
    if (rand == 5);
  ...
  public void setCombatTask() {
    ...
    this.tasks.addTask(5, (EntityAIBase)this.aiAttackOnCollide3);

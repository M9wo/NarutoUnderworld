...
public class ChuninExamGeninEntity extends EntityNinja implements IRangedAttackMob {
  ...
  public ChuninExamGeninEntity(World par1World) {
    super(par1World);
    ...
    setCurrentItemOrArmor(0, new ItemStack(AlcoholMod.ItemWatercuttingSword));
  ...
  protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
    dropItem(AlcoholMod.ChuninExamWinningEmblem, 1);
  }

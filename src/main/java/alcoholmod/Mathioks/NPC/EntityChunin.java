...
public class EntityChunin extends EntityNinja implements IRangedAttackMob {
  ...
  public EntityChunin(World par1World) {
    super(par1World);
    ...
    if (rand == 1)
      setCurrentItemOrArmor(0, new ItemStack(AddedItems.Tanto)); 
    if (rand == 2)
      setCurrentItemOrArmor(0, new ItemStack(AddedItems.Katana2)); 
    if (rand == 3)
  ...
  protected void entityInit() {
    ...
    setTameSkin(this.worldObj.rand.nextInt(7));
  }

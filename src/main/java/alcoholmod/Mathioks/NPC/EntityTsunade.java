...
public class EntityTsunade extends EntitySage implements IRangedAttackMob {
  ...
  public EntityTsunade(World par1World) {
    super(par1World);
        ...
        if (this.Talkative) {
          if (this.beaten != null && this.SageTraining)
            if (this.beaten.toString().equals(p_70085_1_.toString())) {
              p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("§aЦунаде: §rОтлично!"));
              p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("§aЦунаде: §rЯ обновлю местоположение вашего свитка"));
              p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("§aЦунаде: §rВ соответствии с лесом Шиккоцу!"));
            } else {
              p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("§aЦунаде: §rВы не доказали, что достойны обладать Леди Кацую..."));
            }  
        } else {
          this.SageTraining = true;
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("§aЦунаде: §rО, свиток мудреца..!"));
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("§aЦунаде: §rХммм, я сниму его, если сможешь."));
          p_70085_1_.addChatMessage((IChatComponent)new ChatComponentText("§aЦунаде: §rдоказать мне, что ты достоин его!"));
          setHealth(1000.0F);
        }  
    } 

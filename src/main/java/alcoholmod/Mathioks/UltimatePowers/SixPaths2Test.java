...
public class SixPaths2Test extends Item {
  ...
  public SixPaths2Test() {
    setMaxDamage(18000);
    isDamageable();
    this.ironHelmet = new ItemStack(AlcoholMod.helmetSixPaths2);
    this.ironPlate = new ItemStack(AlcoholMod.chestplateSixPaths2);
    this.ironLegs = new ItemStack(AlcoholMod.legsSixPaths2);
    this.ironBoots = new ItemStack(AlcoholMod.bootsSixPaths2);
    this.maxStackSize = 1;
  }

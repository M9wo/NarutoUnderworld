...
public class AkatsukiKisame extends EntityMob {
  Random rand = new Random();
  
  public AkatsukiKisame(World par1World) {
    super(par1World);
    ...
    setCurrentItemOrArmor(0, new ItemStack(AddedItems.SamehadaIcon));
    setSize(0.6F, 1.8F);
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(65.0D);
  ...
  public void onUpdate() {
    ...
    if (this.rand.nextInt(100) == 0 && !this.worldObj.isRemote) {
      ...
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.weakness.id, 150, 10));
    } 
  }

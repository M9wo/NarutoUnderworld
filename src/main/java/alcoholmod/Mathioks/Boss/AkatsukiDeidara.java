...
public class AkatsukiDeidara extends EntityMob {
  Random rand = new Random();
  
  public AkatsukiDeidara(World par1World) {
    super(par1World);
  ...
  public void onUpdate() {
    ...
    if (this.rand.nextInt(100) == 0 && !this.worldObj.isRemote) {
      ...
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 150, 10));
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.confusion.id, 150, 10));
    } 
  }

...
public class AkatsukiObito extends EntityMob {
  Random rand = new Random();
  
  public AkatsukiObito(World par1World) {
    super(par1World);
  ...
  public void onUpdate() {
    ...
    if (this.rand.nextInt(100) == 0 && !this.worldObj.isRemote) {
      ...
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.weakness.id, 100, 10));

...
public class AkatsukiSasori extends EntityMob {
  Random rand = new Random();
  
  public AkatsukiSasori(World par1World) {
    super(par1World);
  ...
  public void onUpdate() {
    ...
    if (this.rand.nextInt(100) == 0 && !this.worldObj.isRemote) {
      ...
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.poison.id, 400, 10));
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.confusion.id, 300, 10));
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.jump.id, 60, 70));
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.harm.id, 300, 10));
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.hunger.id, 300, 10));
    } 
  }

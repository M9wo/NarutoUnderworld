...
public class AkatsukiHidan extends EntityMob {
  Random rand = new Random();
  
  public AkatsukiHidan(World par1World) {
    super(par1World);
    ...
    setCurrentItemOrArmor(0, new ItemStack(AddedItems.scytheHidan));
    setSize(0.6F, 1.8F);
    setSize(0.6F, 1.8F);
  }
  ...
  public void onUpdate() {
    ...
    if (this.rand.nextInt(100) == 0 && !this.worldObj.isRemote) {
      ...
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 100, 50));
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.jump.id, 100, -50));
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.wither.id, 300, 10));
    } 
  }

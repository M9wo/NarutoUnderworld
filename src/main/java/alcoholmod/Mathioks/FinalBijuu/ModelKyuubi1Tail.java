...
public class ModelKyuubi1Tail extends ModelBase {
  ...
  public ModelKyuubi1Tail(float f1) {
    this.wingspeed = f1;
    ...
    setRotation(this.rtHorn5, -0.446143F, 0.0F, 0.0F);
    ...
    setRotation(this.lfHorn5, -0.446143F, 0.0F, 0.0F);
    ...
    setRotation(this.tail1, -0.26025F, 0.0F, 0.0F);
    ...
    setRotation(this.lfHorn2, -0.223071F, 0.0F, 0.0F);
    ...
    setRotation(this.rtHorn2, -0.223071F, 0.0F, 0.0F);
    ...
    setRotation(this.lfLegUppperFire, 0.260246F, 0.0F, 0.26025F);
    ...
    setRotation(this.lfLegLowerFire, -0.446143F, 0.0F, 0.0F);
  ...
  public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    this.lfHorn1.rotateAngleY = this.headFire.rotateAngleY + 0.244F + MathHelper.cos(f2 * 1.3F * this.wingspeed) * 3.141593F * 0.1F;
    ...
    this.lfHorn2.rotateAngleY = this.headFire.rotateAngleY + 0.244F + MathHelper.cos(f2 * 1.3F * this.wingspeed - pi4) * 3.141593F * 0.1F;
    ...
    this.lfHorn3.rotateAngleY = this.headFire.rotateAngleY + 0.244F + MathHelper.cos(f2 * 1.3F * this.wingspeed - 2.0F * pi4) * 3.141593F * 0.1F;
    ...
    this.lfHorn4.rotateAngleY = this.headFire.rotateAngleY + 0.244F + MathHelper.cos(f2 * 1.3F * this.wingspeed - 3.0F * pi4) * 3.141593F * 0.1F;
    ...
    this.lfHorn5.rotateAngleY = this.headFire.rotateAngleY + 0.244F + MathHelper.cos(f2 * 1.3F * this.wingspeed - 4.0F * pi4) * 3.141593F * 0.1F;
    fc = (float)Math.cos((this.headFire.rotateAngleY - pi4));
    fs = (float)Math.sin((this.headFire.rotateAngleY - pi4));
    this.headFire.rotationPointZ -= fc * 3.6F;
    this.headFire.rotationPointX -= fs * 3.6F;
    this.rtHorn1.rotateAngleY = this.headFire.rotateAngleY + -0.244F - MathHelper.cos(f2 * 1.3F * this.wingspeed) * 3.141593F * 0.1F;
    ...
    this.rtHorn2.rotateAngleY = this.headFire.rotateAngleY + -0.244F - MathHelper.cos(f2 * 1.3F * this.wingspeed - pi4) * 3.141593F * 0.1F;
    ...
    this.rtHorn3.rotateAngleY = this.headFire.rotateAngleY + -0.244F - MathHelper.cos(f2 * 1.3F * this.wingspeed - 2.0F * pi4) * 3.141593F * 0.1F;
    ...
    this.rtHorn4.rotateAngleY = this.headFire.rotateAngleY + -0.244F - MathHelper.cos(f2 * 1.3F * this.wingspeed - 3.0F * pi4) * 3.141593F * 0.1F;
    ...
    this.rtHorn5.rotateAngleY = this.headFire.rotateAngleY + -0.244F - MathHelper.cos(f2 * 1.3F * this.wingspeed - 4.0F * pi4) * 3.141593F * 0.1F;
    this.tail1.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed) * 3.141593F * 0.2F;
    this.tail1.rotationPointX -= (float)Math.sin(this.tail1.rotateAngleY) * 3.0F;
    this.tail2.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - pi4) * 3.141593F * 0.2F;
    this.tail2.rotationPointX -= (float)Math.sin(this.tail2.rotateAngleY) * 4.0F;
    this.tail3.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 2.0F * pi4) * 3.141593F * 0.2F;
    this.tail3.rotationPointX -= (float)Math.sin(this.tail3.rotateAngleY) * 3.5F;
    this.tail4.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 3.0F * pi4) * 3.141593F * 0.2F;
    this.tail4.rotationPointX -= (float)Math.sin(this.tail4.rotateAngleY) * 5.0F;
    this.tail5.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 4.0F * pi4) * 3.141593F * 0.2F;
    this.tail5.rotationPointX -= (float)Math.sin(this.tail5.rotateAngleY) * 4.0F;
    this.tail6.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 5.0F * pi4) * 3.141593F * 0.2F;
    this.tail6.rotationPointX -= (float)Math.sin(this.tail6.rotateAngleY) * 3.0F;
    this.tail7.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 6.0F * pi4) * 3.141593F * 0.2F;
    this.tail7.rotationPointX -= (float)Math.sin(this.tail7.rotateAngleY) * 2.0F;
    this.tail8.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 7.0F * pi4) * 3.141593F * 0.2F;
    this.tail8.rotationPointX -= (float)Math.sin(this.tail8.rotateAngleY) * 1.0F;
    this.tail9.rotateAngleY = MathHelper.cos(f2 * 0.9F * this.wingspeed - 8.0F * pi4) * 3.141593F * 0.2F;
    this.tail1.rotateAngleX = -0.26F + MathHelper.cos(f2 * 0.5F * this.wingspeed) * 3.141593F * 0.1F;
    ...
    this.tail2.rotateAngleX = -0.78F + MathHelper.cos(f2 * 0.5F * this.wingspeed - pi4) * 3.141593F * 0.1F;
    ...
    this.tail3.rotateAngleX = -1.11F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 2.0F * pi4) * 3.141593F * 0.1F;
    ...
    this.tail4.rotateAngleX = -0.18F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 3.0F * pi4) * 3.141593F * 0.1F;
    ...
    this.tail5.rotateAngleX = 0.22F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 4.0F * pi4) * 3.141593F * 0.1F;
    ...
    this.tail6.rotateAngleX = 0.63F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 5.0F * pi4) * 3.141593F * 0.1F;
    ...
    this.tail7.rotateAngleX = 0.89F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 6.0F * pi4) * 3.141593F * 0.1F;
    ...
    this.tail8.rotateAngleX = 1.52F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 7.0F * pi4) * 3.141593F * 0.1F;
    ...
    this.tail9.rotateAngleX = 2.0F + MathHelper.cos(f2 * 0.5F * this.wingspeed - 8.0F * pi4) * 3.141593F * 0.1F;
    GL11.glPushMatrix();
    GL11.glEnable(2977);
    GL11.glEnable(3042);

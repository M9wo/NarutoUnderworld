...
public class EntityMatatabi extends EntityMob implements IMob, IBossDisplayData {
  ...
  public EntityMatatabi(World p_i1735_1_) {
    super(p_i1735_1_);
    setSize(10.6F, 7.8F);
  ...
  protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
    dropItem(AlcoholMod.DefeatMatatabi, 1);
  }

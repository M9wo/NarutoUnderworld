...
public class ExplosiveClaySpidersEntity extends EntityTameable {
  ...
  public ExplosiveClaySpidersEntity(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(0.5F, 0.5F);
  ...
  protected void onImpact(MovingObjectPosition par1MovingObjectPosition) {
    if (!this.worldObj.isRemote) {
      ...
      this.worldObj.newExplosion((Entity)this, this.posX, this.posY, this.posZ, this.explosionRadius, false, true);
      setDead();
    } 
  }

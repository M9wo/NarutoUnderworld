package alcoholmod.Mathioks.Final.BijuuTrans;
...
public class ModelCurseModeSasuke extends ModelBase {
  ...
  public ModelCurseModeSasuke() {
    this(0.0F);
  }
  
  public ModelCurseModeSasuke(float p_i1148_1_) {
    this(p_i1148_1_, 0.0F, 64, 32);
  }
  
  public ModelCurseModeSasuke(float p_i1149_1_, float p_i1149_2_, int p_i1149_3_, int p_i1149_4_) {
    ...
    this.bipedHead.setTextureOffset(3, 17).addBox(0.0F, 0.0F, 0.0F, 1, 1, 12, 0.0F);
    this.bipedHead.setTextureOffset(0, 17).addBox(0.0F, 0.0F, 0.0F, 1, 1, 10, 0.0F);
    this.bipedHead.setTextureOffset(0, 0).addBox(0.0F, 0.0F, 0.0F, 1, 2, 10, 0.0F);
    this.bipedHead.setTextureOffset(0, 0).addBox(0.0F, 0.0F, 0.0F, 1, 2, 10, 0.0F);
    this.bipedHead.setTextureOffset(0, 17).addBox(0.0F, 0.0F, 0.0F, 1, 1, 12, 0.0F);
    this.bipedHead.setTextureOffset(0, 19).addBox(0.0F, 0.0F, 0.0F, 1, 1, 10, 0.0F);
    this.bipedHead.setTextureOffset(0, 0).addBox(0.0F, 0.0F, 0.0F, 1, 1, 8, 0.0F);
    this.bipedHead.setTextureOffset(0, 0).addBox(0.0F, 0.0F, 0.0F, 1, 1, 8, 0.0F);
    this.bipedHead.setTextureOffset(3, 17).addBox(0.0F, 0.0F, 0.0F, 1, 1, 12, 0.0F);
    this.bipedHead.setTextureOffset(0, 17).addBox(0.0F, 0.0F, 0.0F, 1, 1, 10, 0.0F);
    this.bipedHead.setTextureOffset(0, 0).addBox(0.0F, 0.0F, 0.0F, 1, 2, 10, 0.0F);
  ...
  public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
    ...
    if (this.isSneak) {
      ...
      ModelRenderer modelRenderer = this.bipedRightArm;
      modelRenderer.rotateAngleX += 0.4F;
      modelRenderer = this.bipedLeftArm;
      modelRenderer.rotateAngleX += 0.4F;

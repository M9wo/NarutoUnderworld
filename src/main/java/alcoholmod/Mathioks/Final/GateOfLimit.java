...
public class GateOfLimit extends Item {
  ...
  public ItemStack onItemRightClick(ItemStack Par1ItemStack, World Par2World, EntityPlayer Par3EntityPlayer) {
    if (!Par2World.isRemote && Par1ItemStack.getItemDamage() == 0) {
      ...
      Par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.jump.id, 400000000, 7));
      Par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 400000000, 10));
      Par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.damageBoost.id, 400000000, 10));
      if (this.counter2 == 0) {
    ...
    if (!Par2World.isRemote && Par1ItemStack.getItemDamage() == 50) {
      ...
      if (this.counter2 == 1) {
        Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Closed The Gate Of Limit"));
        this.counter2 = 0;
      } 
      return Par1ItemStack;
    } 

...
public class RinneganAlmightyPush extends JutsuItem {
    ...
    if (!Par2World.isRemote && Par1ItemStack.stackTagCompound.getString("Owner").equals(Par3EntityPlayer.getCommandSenderName())) {
      ...
      if (counter == 0) {
        ...
        if (props.getrinnegan() == 1 && props.getSharinganSize() == 3.0D) {
          if (props.getCurrentMana() >= 550 + props.getNinjutsu() / 150) {
            ...
            if (Par3EntityPlayer != null)
              for (int k2 = 0; k2 < list.size(); k2++) {
                ...
                if (entity instanceof net.minecraft.entity.EntityLiving) {
                  ...
                  entity.attackEntityFrom(DamageSource.causePlayerDamage(Par3EntityPlayer), 10.0F);
                  if (d0 <= 7.0D) {
            ...
            props.consumeMana(550 + props.getNinjutsu() / 150);
            counter = 1000;
            Par1ItemStack.stackTagCompound.setInteger("counter", counter);
            player.addChatComponentMessage((IChatComponent)new ChatComponentText("Almighty Push!"));
          } else {
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_PURPLE + "Pushes enemies back.");
    par3List.add(EnumChatFormatting.DARK_RED + "Chakra Cost: " + (550 + props.getNinjutsu() / 150));
  }
}

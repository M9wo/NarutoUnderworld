...
public class SuperExplosionEntity extends EntityTameable {
  ...
  public SuperExplosionEntity(World par1World) {
    super(par1World);
  ...
  public boolean attackEntityAsMob(Entity par1Entity) {
    ...
    if (getOwner() != null) {
      ExtendedPlayer props = ExtendedPlayer.get(owner);
      return par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), 1.0F);
    } 
  ...
  protected void onDeathUpdate() {
    ...
    if (!this.worldObj.isRemote)
      this.worldObj.newExplosion((Entity)getOwner(), this.posX, this.posY, this.posZ, 4.0F, false, false); 

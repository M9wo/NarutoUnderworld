...
public class KaguyaClanVine extends JutsuItem {
  @SideOnly(Side.CLIENT)
  public EnumRarity getRarity(ItemStack par1ItemStack) {
    return EnumRarity.epic;
  }
  
  public KaguyaClanVine() {
    this.maxStackSize = 1;
  }
    ...
    if (!Par2World.isRemote)
      if (Par1ItemStack.stackTagCompound.getString("Owner").equals(Par3EntityPlayer.getCommandSenderName())) {
        ...
        if (props.getCurrentMana() >= 20 + props.getNinjutsu() / 600) {
          ...
          EntityKaguyaSpearBones fireball2 = new EntityKaguyaSpearBones(Par2World);
          ...
          Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Dance of the Clematis: Vine!!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "ground at an opponents location far into");
    par3List.add(EnumChatFormatting.DARK_AQUA + "the air, impaling your opponents");

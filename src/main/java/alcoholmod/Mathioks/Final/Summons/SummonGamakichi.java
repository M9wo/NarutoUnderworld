...
public class SummonGamakichi extends JutsuItem {
  public SummonGamakichi() {
    setMaxDamage(10002);
    isDamageable();
    this.maxStackSize = 1;
  }
  ...
  public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
    ...
    if (start) {
      ...
      if (counter >= 55 && counter <= 65) {
        SummonGamakichiEntity fireball2 = new SummonGamakichiEntity(par2World);
      ...
      if (props.getSummoning() >= 70) {
        if (props.getCurrentMana() >= 400 + props.getNinjutsu() / 600) {
          if (Par1ItemStack.getItemDamage() == 0) {
            ...
            Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Summoning : Gamakichi!!!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "'Gamakichi'");
    par3List.add(EnumChatFormatting.DARK_RED + "Right click to mount, while mounted;");
    par3List.add(EnumChatFormatting.DARK_RED + "'" + Keyboard.getKeyName(ClientProxy.keyBindings[22].getKeyCode()) + "' for Toad Oil Bullet '" + Keyboard.getKeyName(ClientProxy.keyBindings[23].getKeyCode()) + "' for Fire Release: Flame Bullet");

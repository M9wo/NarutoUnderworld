...
public class SummonEnderShinobi extends JutsuItem {
  public SummonEnderShinobi() {
    setMaxDamage(10002);
    isDamageable();
    this.maxStackSize = 1;
  }
  ...
  public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
    ...
    if (start) {
      ...
      if (counter >= 55 && counter <= 65) {
        SummonEnderShinobiEntity fireball2 = new SummonEnderShinobiEntity(par2World);
      ...
      if (props.getSummoning() >= 45) {
        if (props.getCurrentMana() >= 45 + props.getNinjutsu() / 600) {
          if (Par1ItemStack.getItemDamage() == 0) {
            ...
            Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Summoning : Slendobi!!!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "with a shinobi Enderman named Slendobi");

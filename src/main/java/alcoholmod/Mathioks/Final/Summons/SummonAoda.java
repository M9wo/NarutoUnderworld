...
public class SummonAoda extends JutsuItem {
  public SummonAoda() {
    setMaxDamage(10002);
    isDamageable();
    this.maxStackSize = 1;
  ...
  public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
    ...
    if (start) {
      ...
      if (counter >= 55 && counter <= 65) {
        SummonAodaEntity fireball2 = new SummonAodaEntity(par2World);
  ...
  public ItemStack onItemRightClick(ItemStack Par1ItemStack, World Par2World, EntityPlayer Par3EntityPlayer) {
    if (!Par2World.isRemote) {
      ...
      if (Par1ItemStack.getItemDamage() == 0) {
        ...
        Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Summoning : Aoda!!!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "'Aoda'");
    par3List.add(EnumChatFormatting.DARK_RED + "Right click to mount, while mounted;");
    par3List.add(EnumChatFormatting.DARK_RED + "'" + Keyboard.getKeyName(ClientProxy.keyBindings[22].getKeyCode()) + "' for Fireball '" + Keyboard.getKeyName(ClientProxy.keyBindings[23].getKeyCode()) + "' for Water Release: Gunshot");
    par3List.add(EnumChatFormatting.GOLD + "Summoning: 70");
    par3List.add(EnumChatFormatting.GOLD + "Chakra Cost: 400");
  }
}

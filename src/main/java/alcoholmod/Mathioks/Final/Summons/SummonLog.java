...
public class SummonLog extends JutsuItem {
  public SummonLog() {
    setMaxDamage(10002);
    isDamageable();
    this.maxStackSize = 1;
  ...
  public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
    ...
    if (start) {
      ...
      if (counter >= 55 && counter <= 65) {
        SummonLogEntity fireball2 = new SummonLogEntity(par2World, (EntityLivingBase)par3Entity);
  ...
  public ItemStack onItemRightClick(ItemStack Par1ItemStack, World Par2World, EntityPlayer Par3EntityPlayer) {
    if (!Par2World.isRemote && 
      !Par1ItemStack.stackTagCompound.getBoolean("start")) {
      ExtendedPlayer props = ExtendedPlayer.get(Par3EntityPlayer);
      if (props.getSummoning() >= 10) {
        if (props.getCurrentMana() >= 15 + props.getNinjutsu() / 600) {
          if (Par1ItemStack.getItemDamage() == 0) {
            ...
            Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Summoning : Rolling Log!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "A summoning jutsu that summons");
    par3List.add(EnumChatFormatting.DARK_AQUA + "a rolling log");
    par3List.add(EnumChatFormatting.YELLOW + "Needed Summoning: 10");

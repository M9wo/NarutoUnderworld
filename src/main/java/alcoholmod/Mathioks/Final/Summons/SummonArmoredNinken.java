...
public class SummonArmoredNinken extends JutsuItem {
  public SummonArmoredNinken() {
    setMaxDamage(10002);
    isDamageable();
    this.maxStackSize = 1;
  }
  ...
  public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
    ...
    if (start) {
      ...
      if (counter >= 55 && counter <= 65) {
        SummonArmoredNinkenEntity fireball2 = new SummonArmoredNinkenEntity(par2World);
      ...
      if (props.getSummoning() >= 35) {
        if (props.getCurrentMana() >= 40 + props.getNinjutsu() / 600) {
          if (Par1ItemStack.getItemDamage() == 0) {
            ...
            Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Summoning : Ni-Inu!!!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "with an Armored Ninken named Ni-Inu");
    par3List.add(EnumChatFormatting.YELLOW + "Needed Summoning: 35");

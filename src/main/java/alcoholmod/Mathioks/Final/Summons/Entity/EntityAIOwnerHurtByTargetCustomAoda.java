...
public class EntityAIOwnerHurtByTargetCustomAoda extends EntityAITarget {
  SummonAodaEntity theDefendingTameable;
  ...
  public EntityAIOwnerHurtByTargetCustomAoda(SummonAodaEntity p_i1667_1_) {

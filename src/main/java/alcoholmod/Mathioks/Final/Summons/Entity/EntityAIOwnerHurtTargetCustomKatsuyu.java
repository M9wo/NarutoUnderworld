...
public class EntityAIOwnerHurtTargetCustomKatsuyu extends EntityAITarget {
  SummonKatsuyuEntity theEntityTameable;
  ...
  public EntityAIOwnerHurtTargetCustomKatsuyu(SummonKatsuyuEntity p_i1668_1_) {

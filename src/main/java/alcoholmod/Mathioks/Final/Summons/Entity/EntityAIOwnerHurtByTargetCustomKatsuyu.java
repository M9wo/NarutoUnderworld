...
public class EntityAIOwnerHurtByTargetCustomKatsuyu extends EntityAITarget {
  SummonKatsuyuEntity theDefendingTameable;
  ...
  public EntityAIOwnerHurtByTargetCustomKatsuyu(SummonKatsuyuEntity p_i1667_1_) {

...
public class SummonMandaEntity extends EntityAnimal implements EntityAbilityExtended {
  ...
  public SummonMandaEntity(World p_i1685_1_) {
    super(p_i1685_1_);
    setSize(3.4F, 11.2F);
    ...
    this.tasks.addTask(5, new EntityAIFollowOwnerCustom(this, 1.0D, 10.0F, 6.0F));
    this.targetTasks.addTask(1, (EntityAIBase)new EntityAIOwnerHurtByTargetCustom(this));
    this.targetTasks.addTask(2, (EntityAIBase)new EntityAIOwnerHurtTargetCustom(this));
  ...
  protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
    dropItem(AlcoholMod.DefeatManda, 1);
  }
  ...
  public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
    if (!(p_142018_1_ instanceof net.minecraft.entity.monster.EntityCreeper) && !(p_142018_1_ instanceof net.minecraft.entity.monster.EntityGhast)) {
      if (p_142018_1_ instanceof SummonMandaEntity) {
        SummonMandaEntity entitywolf = (SummonMandaEntity)p_142018_1_;

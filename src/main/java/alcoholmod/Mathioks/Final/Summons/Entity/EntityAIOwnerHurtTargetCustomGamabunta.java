...
public class EntityAIOwnerHurtTargetCustomGamabunta extends EntityAITarget {
  SummonGamabuntaEntity theEntityTameable;
  ...
  public EntityAIOwnerHurtTargetCustomGamabunta(SummonGamabuntaEntity p_i1668_1_) {

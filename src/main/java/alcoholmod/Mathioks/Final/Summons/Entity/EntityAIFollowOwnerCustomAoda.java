...
public class EntityAIFollowOwnerCustomAoda extends EntityAIBase {
  private SummonAodaEntity thePet;
  ...
  public EntityAIFollowOwnerCustomAoda(SummonAodaEntity p_i1625_1_, double p_i1625_2_, float p_i1625_4_, float p_i1625_5_) {

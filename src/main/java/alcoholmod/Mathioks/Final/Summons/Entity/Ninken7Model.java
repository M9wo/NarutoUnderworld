...
public class Ninken7Model extends ModelBase {
  ...
  public Ninken7Model() {
    ...
    this.WolfHead = new ModelRenderer(this, 6, 53);
    this.WolfHead.addBox(-3.0F, -3.0F, -2.0F, 8, 6, 4);
    this.WolfHead.setRotationPoint(-2.0F, 13.5F, -7.0F);
    this.WolfHead.setTextureSize(64, 128);
    this.WolfHead.mirror = true;
    setRotation(this.WolfHead, 0.0F, 0.0F, 0.0F);
    this.Body = new ModelRenderer(this, 18, 27);
    this.Body.addBox(-4.0F, -2.0F, -3.0F, 8, 14, 6);

...
public class SummonGamakichiModel extends ModelBase {
  ModelRenderer Head2;
  ...
  public SummonGamakichiModel() {
    this.textureWidth = 128;
    this.textureHeight = 128;
    setTextureOffset("Head.Head", 79, 2);
    setTextureOffset("Head.RightEye", 108, 22);
    setTextureOffset("Head.LeftEye", 90, 22);
    ...
    setRotation(this.LeftHand, 0.1745329F, -0.2617994F, -0.3490659F);
    this.Pipe = new ModelRenderer(this, 71, 25);
    this.Pipe.addBox(2.0F, -2.0F, -15.0F, 1, 1, 6);
    this.Pipe.setRotationPoint(0.0F, -1.0F, 0.0F);
    this.Pipe.setTextureSize(128, 128);
    this.Pipe.mirror = true;
    setRotation(this.Pipe, 0.1487144F, 0.5576792F, 0.0F);
    ...
    this.Shape1.addBox(-3.0F, -2.0F, -3.0F, 3, 3, 3);
    this.Shape1.setRotationPoint(0.0F, 3.0F, -3.0F);
    this.Shape1.setTextureSize(128, 128);
    this.Shape1.mirror = true;
    setRotation(this.Shape1, 0.2617994F, -0.6981317F, -0.2617994F);
    this.Head = new ModelRenderer(this, "Head");
    this.Head.setRotationPoint(0.0F, -1.0F, 0.0F);
    setRotation(this.Head, -0.1115358F, 0.0F, 0.0F);
    this.Head.mirror = true;
    this.Head.addBox("Head", -7.0F, -5.0F, -6.0F, 14, 7, 9);
    this.Head.addBox("RightEye", 3.0F, -7.0F, -6.0F, 3, 2, 2);
    this.Head.addBox("LeftEye", -6.0F, -7.0F, -6.0F, 3, 2, 2);

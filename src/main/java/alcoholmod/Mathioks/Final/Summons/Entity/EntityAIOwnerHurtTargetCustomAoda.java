...
public class EntityAIOwnerHurtTargetCustomAoda extends EntityAITarget {
  SummonAodaEntity theEntityTameable;
  ...
  public EntityAIOwnerHurtTargetCustomAoda(SummonAodaEntity p_i1668_1_) {

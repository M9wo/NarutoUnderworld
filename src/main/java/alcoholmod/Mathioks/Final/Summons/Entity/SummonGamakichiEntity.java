...
public class SummonGamakichiEntity extends EntityAnimal implements EntityAbilityExtended {
  private static final IAttribute horseJumpStrength = (IAttribute)(new RangedAttribute("horse.jumpStrength", 3.7D, -10.0D, 6.0D)).setDescription("Jump Strength").setShouldWatch(true);
  ...
  public SummonGamakichiEntity(World p_i1685_1_) {
    super(p_i1685_1_);
    setSize(3.0F, 10.5F);
    ...
    this.tasks.addTask(5, new EntityAIFollowOwnerCustomGamakichi(this, 1.0D, 10.0F, 6.0F));
    this.targetTasks.addTask(1, (EntityAIBase)new EntityAIOwnerHurtByTargetCustomGamakichi(this));
    this.targetTasks.addTask(2, (EntityAIBase)new EntityAIOwnerHurtTargetCustomGamakichi(this));
  ...
  protected void dropRareDrop(int p_70600_1_) {
    ...
    if (j == 1)
      entityDropItem(new ItemStack(AlcoholMod.SummonGamakichi, 1, 1), 0.0F); 
  }
  ...
  public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
    if (!(p_142018_1_ instanceof net.minecraft.entity.monster.EntityCreeper) && !(p_142018_1_ instanceof net.minecraft.entity.monster.EntityGhast)) {
      if (p_142018_1_ instanceof SummonGamakichiEntity) {
        SummonGamakichiEntity entitywolf = (SummonGamakichiEntity)p_142018_1_;
  ...
  public void updateRiderPosition() {
    ...
    if (this.prevRearingAmount > 0.0F) {
      ...
      this.riddenByEntity.setPosition(this.posX + (f2 * f) + 20.0D, this.posY + getMountedYOffset() + this.riddenByEntity.getYOffset() + f3, this.posZ - (f2 * f1));
  ...
  public void ability1(EntityPlayer player) {
    if (!this.worldObj.isRemote) {
      ...
      if (props.getCurrentMana() >= 30 + props.getNinjutsu() / 600) {
        ...
        oilEntity.setPosition(player.posX + look.xCoord * 5.0D, player.posY + look.yCoord * 5.0D, player.posZ + look.zCoord * 5.0D);
  ...
  public void ability2(EntityPlayer player) {
    if (!this.worldObj.isRemote) {
      ExtendedPlayer props = ExtendedPlayer.get(player);
      if (props.getCurrentMana() >= 35 + props.getNinjutsu() / 600) {
        this.worldObj.spawnEntityInWorld((Entity)new EntityFireBulletJutsu(this.worldObj, (EntityLivingBase)player));

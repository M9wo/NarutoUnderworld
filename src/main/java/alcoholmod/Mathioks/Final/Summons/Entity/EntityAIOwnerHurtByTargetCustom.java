...
public class EntityAIOwnerHurtByTargetCustom extends EntityAITarget {
  SummonMandaEntity theDefendingTameable;
  ...
  public EntityAIOwnerHurtByTargetCustom(SummonMandaEntity p_i1667_1_) {

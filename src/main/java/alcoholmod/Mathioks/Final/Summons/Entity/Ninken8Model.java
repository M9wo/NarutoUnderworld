...
public class Ninken8Model extends ModelBase {
  ModelRenderer Head;
  ...
  public Ninken8Model() {
    ...
    this.Head = new ModelRenderer(this, 6, 53);
    this.Head.addBox(-3.0F, -3.0F, -2.0F, 8, 6, 4);
    this.Head.setRotationPoint(-2.0F, 13.5F, -7.0F);

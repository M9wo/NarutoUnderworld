...
public class SummonNinjaZombieModel extends ModelBiped {
  private static final String __OBFID = "CL_00000869";
  
  public SummonNinjaZombieModel() {
    this(0.0F, false);
  }
  
  protected SummonNinjaZombieModel(float p_i1167_1_, float p_i1167_2_, int p_i1167_3_, int p_i1167_4_) {
    super(p_i1167_1_, p_i1167_2_, p_i1167_3_, p_i1167_4_);
  }
  
  public SummonNinjaZombieModel(float p_i1168_1_, boolean p_i1168_2_) {

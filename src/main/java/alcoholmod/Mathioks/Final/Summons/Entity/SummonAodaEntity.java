...
public class SummonAodaEntity extends EntityAnimal implements EntityAbilityExtended {
  private static final IAttribute horseJumpStrength = (IAttribute)(new RangedAttribute("horse.jumpStrength", 3.7D, 0.0D, 6.0D)).setDescription("Jump Strength").setShouldWatch(true);
  ...
  public SummonAodaEntity(World p_i1685_1_) {
    super(p_i1685_1_);
    setSize(3.4F, 11.2F);
    ...
    this.tasks.addTask(5, new EntityAIFollowOwnerCustomAoda(this, 1.0D, 10.0F, 6.0F));
    this.targetTasks.addTask(1, (EntityAIBase)new EntityAIOwnerHurtByTargetCustomAoda(this));
    this.targetTasks.addTask(2, (EntityAIBase)new EntityAIOwnerHurtTargetCustomAoda(this));
  ...
  protected void dropRareDrop(int p_70600_1_) {
    ...
    if (j == 1)
      entityDropItem(new ItemStack(AlcoholMod.SummonAoda, 1, 1), 0.0F); 
  }
  ...
  public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
    if (!(p_142018_1_ instanceof net.minecraft.entity.monster.EntityCreeper) && !(p_142018_1_ instanceof net.minecraft.entity.monster.EntityGhast)) {
      if (p_142018_1_ instanceof SummonAodaEntity) {
        SummonAodaEntity entitywolf = (SummonAodaEntity)p_142018_1_;
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.42499999403953553D);
  }
  ...
  public void onUpdate() {
    ...
    if (this.LowCounter > 0)
      this.LowCounter--; 
    if (!this.worldObj.isRemote && isTame() && this.riddenByEntity != null)
      if (getOwner() != null) {
        if (this.riddenByEntity != getOwner())
          dismountEntity(this.riddenByEntity); 
      } else {
        dismountEntity(this.riddenByEntity);
      }  
    if (!isTame() || this.riddenByEntity != null);
  ...
  public void ability1(EntityPlayer Par3EntityPlayer) {
    if (!this.worldObj.isRemote) {
      ...
      if (props.getCurrentMana() >= 10 + props.getNinjutsu() / 600) {
        ...
        EntityLargeFireball fireball2 = new EntityLargeFireball(this.worldObj, (EntityLivingBase)Par3EntityPlayer, 1.0D, 1.0D, 1.0D);

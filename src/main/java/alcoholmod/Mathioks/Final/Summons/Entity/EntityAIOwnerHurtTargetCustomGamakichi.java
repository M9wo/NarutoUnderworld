...
public class EntityAIOwnerHurtTargetCustomGamakichi extends EntityAITarget {
  SummonGamakichiEntity theEntityTameable;
  ...
  public EntityAIOwnerHurtTargetCustomGamakichi(SummonGamakichiEntity p_i1668_1_) {

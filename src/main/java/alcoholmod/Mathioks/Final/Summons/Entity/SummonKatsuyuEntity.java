...
public class SummonKatsuyuEntity extends EntityAnimal implements EntityAbilityExtended {
  ...
  public SummonKatsuyuEntity(World p_i1685_1_) {
    super(p_i1685_1_);
    setSize(3.4F, 11.2F);
    ...
    this.tasks.addTask(5, new EntityAIFollowOwnerCustomKatsuyu(this, 1.0D, 10.0F, 6.0F));
    this.targetTasks.addTask(1, (EntityAIBase)new EntityAIOwnerHurtByTargetCustomKatsuyu(this));
    this.targetTasks.addTask(2, (EntityAIBase)new EntityAIOwnerHurtTargetCustomKatsuyu(this));
  ...
  protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
    dropItem(AlcoholMod.DefeatKatsuyu, 1);
  }
  ...
  protected void dropRareDrop(int p_70600_1_) {
    ...
    if (j == 1)
      entityDropItem(new ItemStack(AlcoholMod.SummonKatsuyu, 1, 1), 0.0F); 
  }
  ...
  public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
    if (!(p_142018_1_ instanceof net.minecraft.entity.monster.EntityCreeper) && !(p_142018_1_ instanceof net.minecraft.entity.monster.EntityGhast)) {
      if (p_142018_1_ instanceof SummonKatsuyuEntity) {
        SummonKatsuyuEntity entitywolf = (SummonKatsuyuEntity)p_142018_1_;
  ...
  public void onUpdate() {
    ...
    if (this.LowCounter > 0)
      this.LowCounter--; 
    if (!this.worldObj.isRemote && isTame() && this.riddenByEntity != null && this.worldObj.getBlock((int)this.posX, (int)this.boundingBox.minY, (int)this.posZ) == Blocks.water)
      this.motionY = 0.0D; 

...
public class SummonKatsuyu extends JutsuItem {
  public SummonKatsuyu() {
    setMaxDamage(10002);
    isDamageable();
    this.maxStackSize = 1;
  }
      ...
      if (props.getSummoning() >= 70) {
        if (props.getCurrentMana() >= 400 + props.getNinjutsu() / 600) {
          if (Par1ItemStack.getItemDamage() == 0) {
            ...
            Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Summoning : Katsuyu!!!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "'Katsuyu'");

...
public class ItemAmaterasu extends JutsuItem {
  @SideOnly(Side.CLIENT)
  public EnumRarity getRarity(ItemStack par1ItemStack) {
    return EnumRarity.epic;
  }
  
  public ItemAmaterasu() {
    this.maxStackSize = 1;
  }
        ...
        if (props.getSharinganActive()) {
          if (props.getSharingan() >= 4) {
            if (props.getCurrentMana() >= 200 + props.getNinjutsu() / 600) {
              Par2World.spawnEntityInWorld((Entity)new EntityAmaterasu(Par2World, (EntityLivingBase)Par3EntityPlayer));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Amaterasu!!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "Burns anything in sight with black flames");

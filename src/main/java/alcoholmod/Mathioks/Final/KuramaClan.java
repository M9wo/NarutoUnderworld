...
public class KuramaClan extends Item {
  private boolean isinair;
  
  private boolean KuramaMode;
  ...
  public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
    if (this.KuramaMode && !par2World.isRemote) {
      ...
      if (!((EntityPlayer)par3Entity).isPotionActive(Potion.regeneration.id))
        ((EntityPlayer)par3Entity).addPotionEffect(new PotionEffect(Potion.regeneration.id, 5500000, 0)); 
    } 
  }
  ...
  public ItemStack onItemRightClick(ItemStack Par1ItemStack, World Par2World, EntityPlayer Par3EntityPlayer) {
    if (Par1ItemStack.getItemDamage() == 0) {
      ...
      Par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.regeneration.id, 5500000, 0));
      this.KuramaMode = true;

...
public class SteelRelease extends Item {
  private boolean isinair;
  
  private boolean SteelMode;
  ...
  public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
    if (this.SteelMode && !par2World.isRemote) {
      ...
      if (!((EntityPlayer)par3Entity).isPotionActive(Potion.resistance.id))
        ((EntityPlayer)par3Entity).addPotionEffect(new PotionEffect(Potion.resistance.id, 5500000, 3)); 
    } 
  }
  ...
  public ItemStack onItemRightClick(ItemStack Par1ItemStack, World Par2World, EntityPlayer Par3EntityPlayer) {
    if (Par1ItemStack.getItemDamage() == 0) {
      ...
      Par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.resistance.id, 5500000, 3));
      this.SteelMode = true;

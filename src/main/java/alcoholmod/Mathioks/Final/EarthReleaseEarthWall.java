...
public class EarthReleaseEarthWall extends JutsuItem {
  @SideOnly(Side.CLIENT)
  public EnumRarity getRarity(ItemStack par1ItemStack) {
    return EnumRarity.epic;
  }
  
  public EarthReleaseEarthWall() {
    setMaxDamage(3700);
    this.maxStackSize = 1;
  }
    ...
    if (!Par2World.isRemote) {
      ...
      if (props.getEarthRelease() == 1)
        if (props.getCurrentMana() >= 5) {
          JutsuLogic.makeBlockWall(Par2World, (EntityLivingBase)Par3EntityPlayer, (Block)Blockss.jutsuStone, Par1ItemStack.stackTagCompound.getInteger("Counter"));
          if (Par1ItemStack.stackTagCompound.getInteger("Counter") == 0)
            Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Earth Release: Earth-Style Wall!")); 
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "Create a Wall of Stone");

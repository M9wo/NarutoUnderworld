...
public class WindReleaseWindMode extends JutsuItem {
  @SideOnly(Side.CLIENT)
  public EnumRarity getRarity(ItemStack par1ItemStack) {
    return EnumRarity.epic;
  }
  
  public WindReleaseWindMode() {
    setMaxDamage(200);
    isDamageable();
    this.maxStackSize = 1;
  }
      ...
      if (par1ItemStack.stackTagCompound != null) {
        ...
        if (EarthMode) {
          ...
          if (props.getCurrentMana() < 1 && EarthMode) {
            ...
            if (!par2World.isRemote)
              ((EntityPlayer)par3Entity).addChatComponentMessage((IChatComponent)new ChatComponentText("Wind-Mode de-Activate!")); 
          } 
        } 
        if (props.getCurrentMana() < 1 && EarthMode) {
          EarthMode = false;
        ...
        if (props.getWindRelease() == 1)
          if (props.getCurrentMana() >= 5 + props.getNinjutsu() / 600) {
            ...
            if (Par1ItemStack.getItemDamage() == 0) {
              ...
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Wind-Mode Activate!"));
            ...
            if (Par1ItemStack.getItemDamage() == 50) {
              ...
              Par1ItemStack.stackTagCompound.setBoolean("EarthMode", EarthMode);
              Par1ItemStack.setItemDamage(0);
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Wind-Mode de-Activate!"));
            } 
          } else {
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "Activate Wind mode to increase your");

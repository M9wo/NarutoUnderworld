...
public class GateOfHealing extends Item {
  ...
  public ItemStack onItemRightClick(ItemStack Par1ItemStack, World Par2World, EntityPlayer Par3EntityPlayer) {
    if (!Par2World.isRemote && Par1ItemStack.getItemDamage() == 0) {
      Par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.resistance.id, 400000000, 1));
      Par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.jump.id, 400000000, 2));
      Par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 400000000, 2));
      Par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.damageBoost.id, 400000000, 2));
      if (this.counter2 == 0) {
        Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Gate of Healing: OPEN!"));
        if (this.counter2 == 1) {
          Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Closed Healing"));
          this.counter2 = 0;
        } 
      } 

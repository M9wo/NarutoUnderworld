...
public class NaraClanShadowImitationTechnique extends JutsuItem {
  public NaraClanShadowImitationTechnique() {
    setMaxDamage(602);
    isDamageable();
    this.maxStackSize = 1;
  }
  ...
  public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
    ...
    if (start && !par2World.isRemote) {
      ...
      if (counter == 20) {
        ...
        if (par2World.isAirBlock(i - 1, j, k + 2))
          par2World.setBlock(i - 1, j, k + 2, (Block)Blockss.naraShadowBlock); 
        ...
        if (par2World.isAirBlock(i - 2, j, k + 1))
          par2World.setBlock(i - 2, j, k + 1, (Block)Blockss.naraShadowBlock); 
        if (par2World.isAirBlock(i + 2, j, k + 1))
          par2World.setBlock(i + 2, j, k + 1, (Block)Blockss.naraShadowBlock); 
      ...
      if (counter == 25) {
        ...
        if (par2World.isAirBlock(i - 2, j, k - 3))
          par2World.setBlock(i - 2, j, k - 3, (Block)Blockss.naraShadowBlock); 
        if (par2World.isAirBlock(i - 1, j, k - 3))
          par2World.setBlock(i - 1, j, k - 3, (Block)Blockss.naraShadowBlock); 
        ...
        if (par2World.isAirBlock(i - 3, j, k + 2))
          par2World.setBlock(i - 3, j, k + 2, (Block)Blockss.naraShadowBlock); 
        if (par2World.isAirBlock(i + 3, j, k + 2))
          par2World.setBlock(i + 3, j, k + 2, (Block)Blockss.naraShadowBlock); 
        if (par2World.isAirBlock(i - 3, j, k + 1))
          par2World.setBlock(i - 3, j, k + 1, (Block)Blockss.naraShadowBlock); 
        if (par2World.isAirBlock(i + 3, j, k + 1))
          par2World.setBlock(i + 3, j, k + 1, (Block)Blockss.naraShadowBlock); 
    ...
    if (remove && !par2World.isRemote) {
      ...
      if (counter2 >= 15) {
        if (par2World.getBlock(i, j, k) == Blockss.naraShadowBlock)
          par2World.setBlock(i, j, k, Blocks.air); 
      ...
      if (counter2 >= 20) {
        ...
        if (par2World.getBlock(i - 1, j, k + 2) == Blockss.naraShadowBlock)
        ...
        if (par2World.getBlock(i + 2, j, k + 2) == Blockss.naraShadowBlock)
          par2World.setBlock(i + 2, j, k + 2, Blocks.air); 
        if (par2World.getBlock(i - 2, j, k + 1) == Blockss.naraShadowBlock)
      ...
      if (counter2 >= 25) {
        ...
        if (par2World.getBlock(i - 2, j, k - 3) == Blockss.naraShadowBlock)
          par2World.setBlock(i - 2, j, k - 3, Blocks.air); 
        if (par2World.getBlock(i - 1, j, k - 3) == Blockss.naraShadowBlock)
        ...
        if (par2World.getBlock(i + 3, j, k + 3) == Blockss.naraShadowBlock)
          par2World.setBlock(i + 3, j, k + 3, Blocks.air); 
        if (par2World.getBlock(i - 3, j, k + 2) == Blockss.naraShadowBlock)
          par2World.setBlock(i - 3, j, k + 2, Blocks.air); 
        if (par2World.getBlock(i + 3, j, k + 2) == Blockss.naraShadowBlock)
          par2World.setBlock(i + 3, j, k + 2, Blocks.air); 
        if (par2World.getBlock(i - 3, j, k + 1) == Blockss.naraShadowBlock)

...
public class ExplosionReleaseLandmineFist extends JutsuItem {
  ...
  public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase) {
    ...
    if (props.getCurrentMana() >= 25 + props.getNinjutsu() / 300 && par1ItemStack.stackTagCompound.getString("Owner").equals(par3EntityLivingBase.getCommandSenderName()) && props.getexplosionRelease() == 1) {
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "Establish direct contact with a punch to");
    par3List.add(EnumChatFormatting.DARK_AQUA + "create an enormous explosion in the target");
  ...
  public void onUpdate(ItemStack p_77663_1_, World p_77663_2_, Entity p_77663_3_, int p_77663_4_, boolean p_77663_5_) {
    ...
    if (Explode) {
      p_77663_2_.createExplosion(p_77663_3_, p_77663_3_.posX, p_77663_3_.posY, p_77663_3_.posZ, 4.0F, false);
      Explode = false;
      p_77663_1_.stackTagCompound.setBoolean("Explode", false);
    } 
  }

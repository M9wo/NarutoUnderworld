...
public class EdoCageEntity extends EntityThrowable {
  ...
  public EdoCageEntity(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 0.1D;
    this.motionY *= 0.1D;
    this.motionZ *= 0.1D;
  ...
  public EdoCageEntity(World Par4World, EntityLivingBase Par5EntityLivingBase) {
  ...
  public void onUpdate() {
    ...
    if (!this.worldObj.isRemote) {
      ...
      if (this.ticksExisted >= 125) {
        if (getThrower() != null) {
          EntityNarutoMob03 entitychameleon = new EntityNarutoMob03((getThrower()).worldObj);

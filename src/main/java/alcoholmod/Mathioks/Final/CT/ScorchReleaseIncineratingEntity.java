...
public class ScorchReleaseIncineratingEntity extends EntityThrowable implements IMob {
  ...
  public ScorchReleaseIncineratingEntity(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 0.3D;
    this.motionY *= 0.3D;
    this.motionZ *= 0.3D;
  ...
  public ScorchReleaseIncineratingEntity(World Par4World, EntityLivingBase Par5EntityLivingBase) {

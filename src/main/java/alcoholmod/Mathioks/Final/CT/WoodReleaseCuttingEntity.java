...
public class WoodReleaseCuttingEntity extends EntityThrowable {
  ...
  public WoodReleaseCuttingEntity(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 1.0D;
    this.motionY *= 1.0D;
    this.motionZ *= 1.0D;
  ...
  public WoodReleaseCuttingEntity(World Par4World, EntityLivingBase Par5EntityLivingBase) {
      ...
      if (this.start) {
        ...
        if (!(getThrower()).worldObj.isRemote)
          for (int i = 0; i < 40; i++) {
            ...
            (getThrower()).worldObj.setBlock(var10001, var10002, var10003, Blocks.log, 0, 2);
            ...
            var10002 = this.blockPos[i][1];
            var10003 = this.blockPos[i][2];
            (getThrower()).worldObj.setBlock(var10001, var10002, var10003 + 1, Blocks.log, 0, 2);
            var10001 = this.blockPos[i][0] + 1;
            var10002 = this.blockPos[i][1];
            var10003 = this.blockPos[i][2];
            (getThrower()).worldObj.setBlock(var10001, var10002, var10003 + 1, Blocks.log, 0, 2);
                  ...
                  for (int i2 = 0; i2 < 6; i2++) {
                    if ((getThrower()).worldObj.rand.nextBoolean()) {
                      ...
                      if ((getThrower()).worldObj.isAirBlock(var10001, var10002, var10003 - 2 + i2)) {
                        ...
                        var10002 = this.blockPos[i][1] - 2 + i1;
                        var10003 = this.blockPos[i][2];
                        (getThrower()).worldObj.setBlock(var10001, var10002, var10003 - 2 + i2, (Block)Blocks.leaves, 0, 2);
                      } 
                    } 
                  } 
                } 

...
public class WaterSharkRender extends Render {
  private static final ResourceLocation cowTextures = new ResourceLocation("tm:textures/entity/SharkJutsu.png");
  
  protected ModelBase ModelSlowBeam = new WaterSharkModel();
  
  public void flameDragonRender(WaterSharkEntity par1EntityArrow, double par2, double par4, double par6, float par8, float par9) {
    GL11.glPushMatrix();
  ...
  public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
    flameDragonRender((WaterSharkEntity)par1Entity, par2, par4, par6, par8, par9);
  }

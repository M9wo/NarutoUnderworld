...
public class RinneganShuraBlastEntity extends EntityThrowable {
  ...
  public RinneganShuraBlastEntity(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 1.0D;
    this.motionY *= 1.0D;
    this.motionZ *= 1.0D;
  ...
  public RinneganShuraBlastEntity(World Par4World, EntityLivingBase Par5EntityLivingBase) {

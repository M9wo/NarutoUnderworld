...
public class WoodDragonRender extends Render {
  private static final ResourceLocation cowTextures = new ResourceLocation("tm:textures/entity/woodDragon.png");
  
  protected ModelBase ModelSlowBeam = new WoodDragonModel();
  
  public void flameDragonRender(WoodDragonEntity par1EntityArrow, double par2, double par4, double par6, float par8, float par9) {
    GL11.glPushMatrix();
  ...
  public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
    flameDragonRender((WoodDragonEntity)par1Entity, par2, par4, par6, par8, par9);
  }

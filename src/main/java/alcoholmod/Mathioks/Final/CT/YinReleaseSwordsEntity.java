...
public class YinReleaseSwordsEntity extends EntityThrowable {
  ...
  public YinReleaseSwordsEntity(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 1.0D;
    this.motionY *= 1.0D;
    this.motionZ *= 1.0D;
  ...
  public YinReleaseSwordsEntity(World Par4World, EntityLivingBase Par5EntityLivingBase) {

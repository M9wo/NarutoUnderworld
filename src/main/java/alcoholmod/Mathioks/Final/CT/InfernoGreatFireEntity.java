...
public class InfernoGreatFireEntity extends EntityThrowable {
  ...
  public InfernoGreatFireEntity(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 1.0D;
    this.motionY *= 1.0D;
    this.motionZ *= 1.0D;
  ...
  public InfernoGreatFireEntity(World Par4World, EntityLivingBase Par5EntityLivingBase) {
      ...
      for (int k2 = 0; k2 < list.size(); k2++) {
        if (!this.worldObj.isRemote) {
          ...
          if (entity instanceof net.minecraft.entity.EntityLiving) {
            entity.attackEntityFrom(DamageSource.causeThrownDamage((Entity)this, (Entity)getThrower()), 17.0F);
            entity.setFire(50);
          } 

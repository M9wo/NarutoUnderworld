...
public class ShuraBlastEntity extends EntityThrowable {
  ...
  public ShuraBlastEntity(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 1.0D;
    this.motionY *= 1.0D;
    this.motionZ *= 1.0D;
    setSize(0.08125F, 0.08125F);
  }
  
  public ShuraBlastEntity(World Par4World, EntityLivingBase Par5EntityLivingBase) {

...
public class EdoCageEntity_3 extends EntityThrowable {
  ...
  public EdoCageEntity_3(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 0.1D;
    this.motionY *= 0.1D;
    this.motionZ *= 0.1D;
  ...
  public EdoCageEntity_3(World Par4World, EntityLivingBase Par5EntityLivingBase) {
  ...
  public void onUpdate() {
    ...
    if (!this.worldObj.isRemote) {
      ...
      if (this.ticksExisted >= 125) {
        if (getThrower() != null) {
          EntityNarutoMob03_2 entitychameleon = new EntityNarutoMob03_2((getThrower()).worldObj);

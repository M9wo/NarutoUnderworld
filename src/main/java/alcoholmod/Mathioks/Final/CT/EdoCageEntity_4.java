...
public class EdoCageEntity_4 extends EntityThrowable {
  ...
  public EdoCageEntity_4(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 0.1D;
    this.motionY *= 0.1D;
    this.motionZ *= 0.1D;
  ...
  public EdoCageEntity_4(World Par4World, EntityLivingBase Par5EntityLivingBase) {
  ...
  public void onUpdate() {
    ...
    if (!this.worldObj.isRemote) {
      ...
      if (this.ticksExisted >= 125) {
        if (getThrower() != null) {
          EntityNarutoMob03_4 entitychameleon = new EntityNarutoMob03_4((getThrower()).worldObj);

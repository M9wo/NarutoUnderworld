...
public class RashomonItem extends JutsuItem {
  public RashomonItem() {
    setMaxDamage(5100);
    isDamageable();
    this.maxStackSize = 1;
  ...
  public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
    ...
    if (start) {
      ...
      if (counter >= 55 && counter <= 65) {
        RashomonEntity fireball2 = new RashomonEntity(par2World);
        ...
        if (!Summoned && !par2World.isRemote) {
          Vec3 look = ((EntityPlayer)par3Entity).getLookVec();
          EntityPlayer entityPlayer = (EntityPlayer)par3Entity;
          fireball2.setPositionAndRotation(((EntityPlayer)par3Entity).posX + 0.0D, ((EntityPlayer)par3Entity).posY + 0.0D, ((EntityPlayer)par3Entity).posZ, ((EntityPlayer)par3Entity).rotationYaw, ((EntityPlayer)par3Entity).rotationPitch);
          fireball2.rotationYawHead = fireball2.rotationYaw;
          fireball2.renderYawOffset = fireball2.rotationYaw;
      ...
      if (Par1ItemStack.stackTagCompound.getString("Owner").equals(Par3EntityPlayer.getCommandSenderName())) {
        ...
        if (props.getSummoning() >= 50) {
          if (props.getCurrentMana() >= 50) {
            ...
            Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Summoning : Rashomon!!!"));
            Par1ItemStack.damageItem(5000, (EntityLivingBase)Par3EntityPlayer);
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "with Rashomon");
    par3List.add(EnumChatFormatting.YELLOW + "Needed Summoning: 50");
    par3List.add(EnumChatFormatting.GOLD + "Chakra Cost: " + '2');
  }
}

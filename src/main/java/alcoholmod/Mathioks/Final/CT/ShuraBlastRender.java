...
public class ShuraBlastRender extends Render {
  ...
  private final ShuraBlastModel ShuraBlastEntity = new ShuraBlastModel();
  ...
  public void doRender(ShuraBlastEntity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
    GL11.glPushMatrix();
    GL11.glDisable(2884);
    ...
    this.ShuraBlastEntity.render((Entity)p_76986_1_, 0.0F, 0.0F, 0.0F, f2, f3, f4);
    GL11.glPopMatrix();
  }
  
  protected ResourceLocation getEntityTexture(ShuraBlastEntity p_110775_1_) {
    return p_110775_1_.isInvulnerable() ? invulnerableWitherTextures : witherTextures;
  }
  
  protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
    return getEntityTexture((ShuraBlastEntity)p_110775_1_);
  }
  
  public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
    doRender((ShuraBlastEntity)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
  }
}

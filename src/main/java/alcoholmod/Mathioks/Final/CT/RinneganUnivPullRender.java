...
public class RinneganUnivPullRender extends Render {
  private static final ResourceLocation cowTextures = new ResourceLocation("tm:textures/blocks/CT.png");
  
  protected ModelBase ModelSlowBeam = new ModelCT();
  
  public void flameDragonRender(RinneganUnivPullEntity par1EntityArrow, double par2, double par4, double par6, float par8, float par9) {
    GL11.glPushMatrix();
  ...
  public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
    flameDragonRender((RinneganUnivPullEntity)par1Entity, par2, par4, par6, par8, par9);
  }

...
public class EntityC2Dragon extends EntityAnimal {
  ...
  public EntityC2Dragon(World p_i1685_1_) {
    super(p_i1685_1_);
    setSize(3.4F, 3.2F);
  ...
  public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
    if (!(p_142018_1_ instanceof net.minecraft.entity.monster.EntityCreeper) && !(p_142018_1_ instanceof net.minecraft.entity.monster.EntityGhast)) {
      if (p_142018_1_ instanceof EntityC2Dragon) {
        EntityC2Dragon entitywolf = (EntityC2Dragon)p_142018_1_;
  ...
  public void onUpdate() {
    ...
    if (this.LowCounter > 0)
      this.LowCounter--; 
    if (!this.worldObj.isRemote && isTame() && this.riddenByEntity != null && !this.onGround) {
      this.riddenByEntity.motionY = 0.0D;
      this.motionY = 0.0D;
    } 

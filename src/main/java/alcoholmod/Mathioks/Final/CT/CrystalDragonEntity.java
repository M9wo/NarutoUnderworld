...
public class CrystalDragonEntity extends EntityThrowable {
  ...
  public CrystalDragonEntity(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 1.2D;
    this.motionY *= 1.2D;
    this.motionZ *= 1.2D;
  ...
  public CrystalDragonEntity(World Par4World, EntityLivingBase Par5EntityLivingBase) {

...
public class SteelReleaseSteelProjectileEntity extends EntityThrowable {
  ...
  public SteelReleaseSteelProjectileEntity(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 0.65D;
    this.motionY *= 0.65D;
    this.motionZ *= 0.65D;
  ...
  public SteelReleaseSteelProjectileEntity(World Par4World, EntityLivingBase Par5EntityLivingBase) {

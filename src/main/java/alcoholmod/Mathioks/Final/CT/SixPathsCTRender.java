...
public class SixPathsCTRender extends Render {
  ...
  public void flameDragonRender(SixPathsCTEntity par1EntityArrow, double par2, double par4, double par6, float par8, float par9) {
    GL11.glPushMatrix();
  ...
  public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
    flameDragonRender((SixPathsCTEntity)par1Entity, par2, par4, par6, par8, par9);
  }

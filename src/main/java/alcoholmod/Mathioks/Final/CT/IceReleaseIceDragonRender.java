...
public class IceReleaseIceDragonRender extends Render {
  private static final ResourceLocation cowTextures = new ResourceLocation("tm:textures/entity/iceDragon.png");
  
  protected ModelBase ModelSlowBeam = new WaterDragonModel();
  
  public void flameDragonRender(IceReleaseIceDragonEntity par1EntityArrow, double par2, double par4, double par6, float par8, float par9) {
    GL11.glPushMatrix();
  ...
  public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
    flameDragonRender((IceReleaseIceDragonEntity)par1Entity, par2, par4, par6, par8, par9);
  }

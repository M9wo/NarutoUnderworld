...
public class WoodReleasePillarPrisonRender extends Render {
  private static final ResourceLocation cowTextures = new ResourceLocation("tm:textures/entity/WoodReleaseCutting.png");
  
  protected ModelBase ModelSlowBeam = new WoodReleasePillarPrisonModel();
  
  public void matatabiflameDragonRender(WoodReleasePillarPrisonEntity par1EntityArrow, double par2, double par4, double par6, float par8, float par9) {
    GL11.glPushMatrix();
    GL11.glTranslatef((float)par2, (float)par4 + 0.35F, (float)par6);
  ...
  public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
    matatabiflameDragonRender((WoodReleasePillarPrisonEntity)par1Entity, par2, par4, par6, par8, par9);
  }

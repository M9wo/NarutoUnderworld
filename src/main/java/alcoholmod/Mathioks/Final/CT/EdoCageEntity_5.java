...
public class EdoCageEntity_5 extends EntityThrowable {
  ...
  public EdoCageEntity_5(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 0.1D;
    this.motionY *= 0.1D;
    this.motionZ *= 0.1D;
  ...
  public EdoCageEntity_5(World Par4World, EntityLivingBase Par5EntityLivingBase) {
  ...
  public void onUpdate() {
    ...
    if (!this.worldObj.isRemote) {
      ...
      if (this.ticksExisted >= 125) {
        if (getThrower() != null) {
          EntityNarutoMob03_5 entitychameleon = new EntityNarutoMob03_5((getThrower()).worldObj);

...
public class ExtraArmor9 extends ItemArmor {
  ...
  public ExtraArmor9(ItemArmor.ArmorMaterial armorMaterial_, int renderindex, int armorType) {
  ...
  public void registerIcons(IIconRegister reg) {
    if (this == AlcoholMod.helmetObitoYoung)
      this.itemIcon = reg.registerIcon("tm:obito_head"); 
    if (this == AlcoholMod.chestplateObitoYoung)
      this.itemIcon = reg.registerIcon("tm:obito_chest"); 
    if (this == AlcoholMod.legsObitoYoung)
      this.itemIcon = reg.registerIcon("tm:obito_leg"); 
    if (this == AlcoholMod.bootsObitoYoung)
      this.itemIcon = reg.registerIcon("tm:obito_boots"); 
  }

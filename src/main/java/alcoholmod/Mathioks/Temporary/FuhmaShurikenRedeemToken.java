package alcoholmod.Mathioks.Temporary;
...
public class FuhmaShurikenRedeemToken extends Item {
  ...
  public FuhmaShurikenRedeemToken() {
    setMaxDamage(500);
    this.maxStackSize = 1;
  }
        ...
        if (!Par3EntityPlayer.capabilities.isCreativeMode) {
          ...
          if (EmptySpaces > 0) {
            if (props.getJutsuPoints() >= 5 && Par1ItemStack.getItemDamage() == 0) {
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.ShurikenItem));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Created your own Fuhma Shuriken!"));
              ...
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.CurseMandala));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Kinjutsu: Curse Mandala!"));
              ...
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.ChakraThreads));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You Learned Kinjutsu: Chakra Threads!"));
              props.setJutsuPoints(props.getJutsuPoints() - 20);
              PacketDispatcher.sendTo((IMessage)new SyncJutsuPointsMessage(Par3EntityPlayer), (EntityPlayerMP)Par3EntityPlayer);
              Par1ItemStack.stackSize--;
            } else if (props.getJutsuPoints() >= 25 && Par1ItemStack.getItemDamage() == 300) {
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("No more available jutsu yet"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    if (par1ItemStack.getItemDamage() == 0) {
      par3List.add(EnumChatFormatting.GOLD + "Create your own Fuhma Shuriken!");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 5 JP");
    } 
    if (par1ItemStack.getItemDamage() == 100) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Kinjutsu: Curse Mandala");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 15 JP");
    } 
    if (par1ItemStack.getItemDamage() == 200) {
      par3List.add(EnumChatFormatting.GOLD + "Learn Kinjutsu: Chakra Threads");
      par3List.add(EnumChatFormatting.DARK_RED + "Cost: 20 JP");
    } 
    if (par1ItemStack.getItemDamage() == 300)
      par3List.add(EnumChatFormatting.STRIKETHROUGH + "Not more available jutsu"); 

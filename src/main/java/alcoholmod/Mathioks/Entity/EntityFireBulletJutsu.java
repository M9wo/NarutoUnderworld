...
public class EntityFireBulletJutsu extends EntityThrowable {
  ...
  public EntityFireBulletJutsu(World Par1World) {
    super(Par1World);
    this.motionX *= 1.0D;
    this.motionY *= 1.0D;
    this.motionZ *= 1.0D;
  ...
  public EntityFireBulletJutsu(World Par4World, EntityLivingBase Par5EntityLivingBase) {
  ...
  public EntityFireBulletJutsu(World Par6World, double Par7double, double Par8double, double Par9double) {

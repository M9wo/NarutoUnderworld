...
public class DarkWolf extends ModelBase {
  ...
  public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
    EntityDarkWolfMob entityDarkwolfMob = (EntityDarkWolfMob)p_78086_1_;
    if (entityDarkwolfMob.isAngry()) {
      this.Tail.rotateAngleY = 0.0F;
    } else {
      this.Tail.rotateAngleY = MathHelper.cos(p_78086_2_ * 0.6662F) * 1.4F * p_78086_3_;
    } 
    if (entityDarkwolfMob.isSitting()) {
    ...
    this.WolfHead.rotateAngleZ = entityDarkwolfMob.getInterestedAngle(p_78086_4_) + entityDarkwolfMob.getShakeAngle(p_78086_4_, 0.0F);
    this.Mane.rotateAngleZ = entityDarkwolfMob.getShakeAngle(p_78086_4_, -0.08F);
    this.Body.rotateAngleZ = entityDarkwolfMob.getShakeAngle(p_78086_4_, -0.16F);
    this.Tail.rotateAngleZ = entityDarkwolfMob.getShakeAngle(p_78086_4_, -0.2F);
  }
}

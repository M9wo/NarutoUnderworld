...
public class EntityByukuganVaccumPalm extends EntityThrowable {
  ...
  public EntityByukuganVaccumPalm(World Par1World) {
    super(Par1World);
    this.motionX *= 1.0D;
    this.motionY *= 1.0D;
    this.motionZ *= 1.0D;
  ...
  public EntityByukuganVaccumPalm(World Par4World, EntityLivingBase Par5EntityLivingBase) {
  ...
  public EntityByukuganVaccumPalm(World Par6World, double Par7double, double Par8double, double Par9double) {
  ...
  protected void onImpact(MovingObjectPosition Par1MovingObjectPosition) {
    if (Par1MovingObjectPosition.entityHit != null) {
      ...
      Par1MovingObjectPosition.entityHit.addVelocity((-MathHelper.sin(this.rotationYaw * 3.141593F / 180.0F) * j * 0.5F) / 88.0D, 0.1D, (MathHelper.cos(this.rotationYaw * 3.141593F / 180.0F) * j * 0.5F) / 88.0D);
    } else {
      setDead();
    } 
  }

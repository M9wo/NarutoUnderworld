...
public class EntityWindAirBullets extends EntityThrowable {
  ...
  public EntityWindAirBullets(World Par1World) {
    super(Par1World);
    this.motionX *= 0.5D;
    this.motionY *= 0.5D;
    this.motionZ *= 0.5D;
  ...
  public EntityWindAirBullets(World Par4World, EntityLivingBase Par5EntityLivingBase) {
  ...
  public EntityWindAirBullets(World Par6World, double Par7double, double Par8double, double Par9double) {
  ...
  public void onUpdate() {
    ...
    float f3 = 5.25F;
    for (int i = 0; i < 38; i++)
      this.worldObj.spawnParticle("explode", this.posX - this.motionX * f3 + this.rand.nextDouble() * 0.6D - 0.3D, this.posY - this.motionY * f3 - 0.5D, this.posZ - this.motionZ * f3 + this.rand.nextDouble() * 0.6D - 0.3D, this.motionX, this.motionY, this.motionZ); 
    this.deathcounter++;

...
public class ModelTrayaurus extends ModelBase {
  ...
  public ModelTrayaurus(float p_i1163_1_) {
    this(p_i1163_1_, 0.0F, 64, 64);
  }
  
  public ModelTrayaurus(float p_i1164_1_, float p_i1164_2_, int p_i1164_3_, int p_i1164_4_) {

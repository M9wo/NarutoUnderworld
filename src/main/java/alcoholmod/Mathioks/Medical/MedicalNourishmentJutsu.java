...
public class MedicalNourishmentJutsu extends JutsuItem {
  private int counter;
  ...
  public MedicalNourishmentJutsu() {
    setMaxDamage(200);
    isDamageable();
    this.maxStackSize = 1;
  }
  ...
  public boolean onLeftClickEntity(ItemStack Par1ItemStack, EntityPlayer Par3EntityPlayer, Entity entity) {
    if (!Par3EntityPlayer.worldObj.isRemote && Par1ItemStack.stackTagCompound.getString("Owner").equals(Par3EntityPlayer.getCommandSenderName())) {
      ...
      if (counter >= 50 && entity instanceof EntityPlayer) {
        ((EntityPlayer)entity).getFoodStats().addStats(2, 0.1F);
        counter = 0;
        Par1ItemStack.stackTagCompound.setInteger("counter", counter);
        props.consumeMana(5);
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "relieves the feeling of hunger");
    par3List.add(EnumChatFormatting.DARK_AQUA + "of the user or target");
  }
}

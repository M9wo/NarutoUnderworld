...
public class MedicalCreationRebirth extends JutsuItem {
      ...
      if (par1ItemStack.stackTagCompound != null && par1ItemStack.getItemDamage() == 100) {
        ...
        if (counter == 20) {
          if (player.getMaxHealth() != player.getHealth())
            if (props.getCurrentMana() >= 120) {
              player.setHealth(player.getHealth() + 5.0F);
              props.consumeMana(120);
            } else {
        ...
        if (props.getCurrentMana() == 0) {
          ...
          player.addChatComponentMessage((IChatComponent)new ChatComponentText("Medical Ninjutsu: Creation Rebirth De-Activate"));
        } 
      } 
    } 
  }
      ...
      if (Par1ItemStack.stackTagCompound.getString("Owner").equals(Par3EntityPlayer.getCommandSenderName())) {
        if (Par1ItemStack.getItemDamage() == 0) {
          ...
          if (props.getCurrentMana() >= 200) {
            ...
            Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Medical Ninjutsu: Creation Rebirth!"));
          } else {
          ...
          Par1ItemStack.setItemDamage(0);
          Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Medical Ninjutsu: Creation Rebirth De-Activate"));
        } 
      } else {

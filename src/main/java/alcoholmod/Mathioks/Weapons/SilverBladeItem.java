...
public class SilverBladeItem extends ItemSword {
  public SilverBladeItem(Item.ToolMaterial mat) {
    super(mat);
    setFull3D();
    setUnlocalizedName("silverBladei");
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    par3List.add(EnumChatFormatting.DARK_AQUA + "A tanto used originally by Sakumo");
    par3List.add(EnumChatFormatting.DARK_AQUA + "and Kakashi Hatake of the hidden leaf");

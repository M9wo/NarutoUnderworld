...
public class Katana7Item extends ItemSword {
  public Katana7Item(Item.ToolMaterial mat) {
    super(mat);
    setFull3D();
    setUnlocalizedName("katana7i");
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    par3List.add(EnumChatFormatting.DARK_AQUA + "A Katana somewhat resembling");
    par3List.add(EnumChatFormatting.DARK_AQUA + "a sword used by a shark pirate");

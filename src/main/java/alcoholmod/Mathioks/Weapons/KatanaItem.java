...
public class KatanaItem extends ItemSword {
  public KatanaItem(Item.ToolMaterial mat) {
    super(mat);
    setFull3D();
    setUnlocalizedName("katana4i");
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.GOLD + "Kenjutsu: 275");
  }
}

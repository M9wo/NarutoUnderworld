...
public class KusanagiItem extends ItemSword {
  public KusanagiItem(Item.ToolMaterial mat) {
    super(mat);
    setFull3D();
    setUnlocalizedName("kusanagiii");
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    par3List.add(EnumChatFormatting.DARK_AQUA + "A Sword of legend");

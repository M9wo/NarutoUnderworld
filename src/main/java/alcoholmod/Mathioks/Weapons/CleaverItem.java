...
public class CleaverItem extends ItemSword {
  public CleaverItem(Item.ToolMaterial mat) {
    super(mat);
    setFull3D();
    setUnlocalizedName("cleaveri");
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    par3List.add(EnumChatFormatting.DARK_AQUA + "A Sword of legend that can");
    par3List.add(EnumChatFormatting.DARK_AQUA + "cut through almost anything");

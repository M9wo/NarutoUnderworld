...
public class TantoStoneItem extends ItemSword {
  public TantoStoneItem(Item.ToolMaterial mat) {
    super(mat);
    setFull3D();
    setUnlocalizedName("tantoStonei");
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    par3List.add(EnumChatFormatting.DARK_AQUA + "A short katana made");
    par3List.add(EnumChatFormatting.DARK_AQUA + "out of stone");

...
public class LightningBladeItem extends ItemSword {
  public LightningBladeItem(Item.ToolMaterial mat) {
    super(mat);
    setFull3D();
    setUnlocalizedName("lightningBladei");
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    par3List.add(EnumChatFormatting.DARK_AQUA + "A Sword of legend used by the");
    par3List.add(EnumChatFormatting.DARK_AQUA + "second hokage");

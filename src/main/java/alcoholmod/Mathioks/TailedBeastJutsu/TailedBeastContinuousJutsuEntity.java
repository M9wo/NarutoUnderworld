...
public class TailedBeastContinuousJutsuEntity extends EntityThrowable {
  ...
  public TailedBeastContinuousJutsuEntity(World p_i1793_1_) {
    super(p_i1793_1_);
    this.motionX *= 1.0D;
    this.motionY *= 1.0D;
    this.motionZ *= 1.0D;
  ...
  public TailedBeastContinuousJutsuEntity(World Par4World, EntityLivingBase Par5EntityLivingBase) {
      ...
      for (int k2 = 0; k2 < list.size(); k2++) {
        if (!this.worldObj.isRemote) {
          ...
          if (entity instanceof net.minecraft.entity.EntityLiving) {
            float var4 = 1.0F;
            entity.attackEntityFrom(DamageSource.causeThrownDamage((Entity)this, (Entity)getThrower()), 35.0F);

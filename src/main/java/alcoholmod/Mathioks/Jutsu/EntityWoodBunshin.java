...
public class EntityWoodBunshin extends EntityTameable {
  ...
  public EntityWoodBunshin(World par1World) {
    super(par1World);
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.34D);
  ...
  public void onKillEntity(EntityLivingBase p_70074_1_) {
    ...
    if (getOwner() != null && 
      ...
      !(p_70074_1_ instanceof net.minecraft.entity.passive.EntityAnimal) && !(p_70074_1_ instanceof net.minecraft.entity.passive.EntityWaterMob) && !(p_70074_1_ instanceof net.minecraft.entity.passive.EntityAmbientCreature)) {

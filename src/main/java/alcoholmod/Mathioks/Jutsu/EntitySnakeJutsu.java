...
public class EntitySnakeJutsu extends EntityTameable {
  ...
  public EntitySnakeJutsu(World par1World) {
    super(par1World);
  ...
  public boolean attackEntityAsMob(Entity par1Entity) {
    ...
    if (getOwner() != null) {
      ...
      if (par1Entity instanceof EntityLiving)
        ((EntityLiving)par1Entity).addPotionEffect(new PotionEffect(Potion.poison.id, 10, 0)); 
      return (getOwner() instanceof EntityPlayer) ? par1Entity.attackEntityFrom(DamageSource.causePlayerDamage((EntityPlayer)getOwner()), 2.0F) : par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), 2.0F);
    } 

...
public class RenderYamanakaFool extends RenderBiped {
  private static final ResourceLocation Player_Texture = new ResourceLocation("tm:textures/entity/steve.png");
  
  public RenderYamanakaFool(ModelBiped p_i1262_1_, float p_i1262_2_) {
    super(p_i1262_1_, p_i1262_2_);
  }
  
  public RenderYamanakaFool(ModelBunshin model, float size) {
    super(model, size);
  }
  
  protected ResourceLocation getEntityTexture(Entity entity) {
    EntityYamanakaFool clone = (EntityYamanakaFool)entity;
    if (clone != null) {

...
public class EntityKageBunshin extends EntityTameable {
  ...
  public EntityKageBunshin(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(0.6F, 1.8F);
  ...
  protected String getLivingSound() {
    return isAngry() ? "tm:LuffyNowGumGum" : ((this.rand.nextInt(3) == 0) ? ((isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0F) ? "tm:brookViolin" : "tm:LuffyEating") : "tm:LuffyHuHeh");
  }
  ...
  public boolean interact(EntityPlayer p_70085_1_) {
    ...
    if (isTamed()) {
      if (itemstack != null)
        if (itemstack.getItem() instanceof ItemFood) {
          ...
          if (itemfood.isWolfsFavoriteMeat() && this.dataWatcher.getWatchableObjectFloat(18) < 50.0F) {
    ...
    } else if (itemstack != null && itemstack.getItem() == Items.cake && !isAngry()) {
      if (!p_70085_1_.capabilities.isCreativeMode)
        itemstack.stackSize--; 
      if (itemstack.stackSize <= 0)
        p_70085_1_.inventory.setInventorySlotContents(p_70085_1_.inventory.currentItem, (ItemStack)null); 

...
public class StormReleaseBlackHunting2Entity extends EntityTameable {
  ...
  public StormReleaseBlackHunting2Entity(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(1.9F, 2.2F);
  ...
  public boolean attackEntityAsMob(Entity par1Entity) {
    ((EntityLivingBase)par1Entity).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 320, 5));
    return par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), 10.0F);
  }
  ...
  public void onUpdate() {
    ...
    if (this.ticksExisted >= 300)
      setDead(); 
    List<Entity> list = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)getOwner(), AxisAlignedBB.getBoundingBox(this.posX - 6.0D, this.posY - 12.0D, this.posZ - 6.0D, this.posX + 6.0D, this.posY + 6.0D, this.posZ + 6.0D));
    for (int k2 = 0; k2 < list.size(); k2++) {
      Entity entity = list.get(k2);
      if (entity instanceof EntityLiving && entity != getOwner() && !(entity instanceof StormReleaseBlackHunting2Entity)) {
        ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 60, 10));
        ((EntityLivingBase)entity).addPotionEffect(new PotionEffect(Potion.jump.id, 60, -10));
        entity.attackEntityFrom(DamageSource.causeThrownDamage((Entity)this, (Entity)getOwner()), 6.0F);
      } 
    } 
  }
    ...
    if (isTamed()) {
      if (itemstack != null)
        if (itemstack.getItem() instanceof ItemFood) {
          ...
          if (itemfood.isWolfsFavoriteMeat() && this.dataWatcher.getWatchableObjectFloat(18) < 25.0F) {

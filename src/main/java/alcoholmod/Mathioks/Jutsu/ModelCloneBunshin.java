...
public class ModelCloneBunshin extends ModelBase {
  ...
  public ModelCloneBunshin() {
    this(0.0F);
  }
  
  public ModelCloneBunshin(float par1) {
    this(par1, 0.0F, 64, 32);
  }
  
  public ModelCloneBunshin(float par1, float par2, int par3, int par4) {

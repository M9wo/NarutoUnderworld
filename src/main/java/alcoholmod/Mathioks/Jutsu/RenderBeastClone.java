...
public class RenderBeastClone extends RenderBiped {
  private static final ResourceLocation Player_Texture = new ResourceLocation("tm:textures/entity/steve.png");
  
  public RenderBeastClone(ModelBiped p_i1262_1_, float p_i1262_2_) {
    super(p_i1262_1_, p_i1262_2_);
  }
  
  public RenderBeastClone(ModelBunshin model, float size) {
    super(model, size);
  }
  
  protected ResourceLocation getEntityTexture(Entity entity) {
    EntityBeastClone clone = (EntityBeastClone)entity;
    if (clone != null) {

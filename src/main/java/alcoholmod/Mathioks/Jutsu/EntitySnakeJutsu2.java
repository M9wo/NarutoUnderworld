...
public class EntitySnakeJutsu2 extends EntityTameable {
  ...
  public EntitySnakeJutsu2(World par1World) {
    super(par1World);
  ...
  public boolean attackEntityAsMob(Entity par1Entity) {
    ...
    if (par1Entity instanceof EntityPlayer) {
      ((EntityLivingBase)par1Entity).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 50, 30));
      addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 50, 30));
      ((EntityLivingBase)par1Entity).addPotionEffect(new PotionEffect(Potion.jump.id, -2, 30));
      addPotionEffect(new PotionEffect(Potion.jump.id, -2, 30));
      return false;
    } 
    ((EntityLivingBase)par1Entity).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 50, 30));
    addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 50, 30));

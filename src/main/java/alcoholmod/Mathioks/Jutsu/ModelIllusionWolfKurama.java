...
public class ModelIllusionWolfKurama extends ModelBase {
  ...
  public ModelIllusionWolfKurama() {
  ...
  public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
    EntityIllusionWolfKurama entityIllusionWolfKurama = (EntityIllusionWolfKurama)p_78086_1_;
    if (entityIllusionWolfKurama.isAngry()) {
      this.Tail.rotateAngleY = 0.0F;
    } else {
      this.Tail.rotateAngleY = MathHelper.cos(p_78086_2_ * 0.6662F) * 1.4F * p_78086_3_;
    } 
    if (entityIllusionWolfKurama.isSitting()) {
    ...
    this.WolfHead.rotateAngleZ = entityIllusionWolfKurama.getInterestedAngle(p_78086_4_) + entityIllusionWolfKurama.getShakeAngle(p_78086_4_, 0.0F);
    this.Mane.rotateAngleZ = entityIllusionWolfKurama.getShakeAngle(p_78086_4_, -0.08F);
    this.Body.rotateAngleZ = entityIllusionWolfKurama.getShakeAngle(p_78086_4_, -0.16F);
    this.Tail.rotateAngleZ = entityIllusionWolfKurama.getShakeAngle(p_78086_4_, -0.2F);
  }
}

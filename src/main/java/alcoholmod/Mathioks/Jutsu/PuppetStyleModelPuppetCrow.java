...
public class PuppetStyleModelPuppetCrow extends ModelBase {
  ...
  public PuppetStyleModelPuppetCrow() {
  ...
  public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
    float f6 = p_78087_3_ * 3.1415927F * -0.1F;
    int i;
    for (i = 0; i < 4; i++) {
    ...
    f6 = 0.7853982F + p_78087_3_ * 3.1415927F * 0.03F;
    for (i = 4; i < 8; i++) {
      (this.blazeSticks[i]).rotationPointY = 2.0F + MathHelper.cos(((i * 2) + p_78087_3_) * 0.25F);
    ...
    f6 = 0.47123894F + p_78087_3_ * 3.1415927F * -0.05F;
    for (i = 8; i < 12; i++) {

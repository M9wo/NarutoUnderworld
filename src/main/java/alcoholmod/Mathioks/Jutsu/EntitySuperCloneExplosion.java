...
public class EntitySuperCloneExplosion extends EntityTameable {
  ...
  public EntitySuperCloneExplosion(World par1World) {
    super(par1World);
  ...
  protected void onDeathUpdate() {
    ...
    if (this.deathTicks == 1 && !this.worldObj.isRemote) {
      this.worldObj.newExplosion((Entity)getOwner(), this.posX, this.posY, this.posZ, this.explosionRadius, false, false);
      setDead();
    } 
  }

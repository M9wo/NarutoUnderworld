...
public class EntityIllusionWolfKurama extends EntityTameable {
  ...
  public EntityIllusionWolfKurama(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(0.9F, 1.2F);
  ...
  public void onKillEntity(EntityLivingBase p_70074_1_) {
    ...
    if (getOwner() != null && 
      ...
      !(p_70074_1_ instanceof EntityAnimal)) {
  ...
  protected String getLivingSound() {
    return isAngry() ? "mob.wolf.bark" : ((this.rand.nextInt(3) == 0) ? ((isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0F) ? "mob.wolf.whine" : "mob.wolf.panting") : "mob.wolf.bark");
  }
  ...
  public boolean attackEntityAsMob(Entity p_70652_1_) {
    int i = isTamed() ? 4 : 2;
    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 320, 5));

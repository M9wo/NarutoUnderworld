...
public class EntityMoonBunshin extends EntityTameable {
  ...
  public EntityMoonBunshin(World par1World) {
    super(par1World);
  ...
  public void onKillEntity(EntityLivingBase p_70074_1_) {
    ...
    if (getOwner() != null && 
      ...
      !(p_70074_1_ instanceof net.minecraft.entity.passive.EntityAnimal)) {
  ...
  public boolean attackEntityAsMob(Entity par1Entity) {
    ...
    if (getOwner() != null) {
      EntityPlayer owner = (EntityPlayer)getOwner();
      ExtendedPlayer props = ExtendedPlayer.get(owner);
      return par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), (float)props.getKenjutsu());
    } 
    ...
    if (getOwner() != null) {
      ...
      if (Entity != null)
        if (Entity.inventory.getCurrentItem() != null) {
          if (Entity.inventory.getCurrentItem().getItem() instanceof net.minecraft.item.ItemSword) {

...
public class NightPhoenix extends JutsuItem {
            ...
            for (int k2 = 0; k2 < list.size(); k2++) {
              if (!par2World.isRemote) {
                ...
                if (entity instanceof net.minecraft.entity.EntityLiving && entity instanceof net.minecraft.entity.EntityLiving) {
                  entity.setFire(100);
                  entity.attackEntityFrom(DamageSource.causePlayerDamage(player), 15.0F + (int)props.getTaijutsu());
                  if (d0 <= 10.0D) {
  ...
  public ItemStack onItemRightClick(ItemStack Par1ItemStack, World Par2World, EntityPlayer Par3EntityPlayer) {
    ...
    if (counter == 0 && 
      ...
      if (Par1ItemStack.stackTagCompound.getString("Owner").equals(Par3EntityPlayer.getCommandSenderName())) {
        ...
        Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Night Phoenix!"));
      } else {
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "A taijutsu developped by Might Guy");
    par3List.add(EnumChatFormatting.DARK_AQUA + "when it hits the opponent, they are");
    par3List.add(EnumChatFormatting.DARK_AQUA + "set ablaze.");
    par3List.add(EnumChatFormatting.DARK_RED + "Damage: " + (15 + (int)props.getTaijutsu()));
  }
}

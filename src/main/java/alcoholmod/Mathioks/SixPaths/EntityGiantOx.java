...
public class EntityGiantOx extends EntityTameable {
  ...
  public EntityGiantOx(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(4.0F, 5.0F);
  ...
  public boolean attackEntityAsMob(Entity p_70652_1_) {
    ...
    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.harm.id, 160, 0));

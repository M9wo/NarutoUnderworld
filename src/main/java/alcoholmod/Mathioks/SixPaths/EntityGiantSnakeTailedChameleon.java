...
public class EntityGiantSnakeTailedChameleon extends EntityTameable {
  ...
  public EntityGiantSnakeTailedChameleon(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(4.0F, 3.0F);
  ...
  public boolean attackEntityAsMob(Entity p_70652_1_) {
    int i = isTamed() ? 4 : 2;
    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.hunger.id, 160, 0));
    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.wither.id, 160, 0));

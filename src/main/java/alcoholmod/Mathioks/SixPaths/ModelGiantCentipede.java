...
public class ModelGiantCentipede extends ModelBase {
  ModelRenderer body;
  ...
  public void setLivingAnimations(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4) {
    EntityGiantCentipede par1EntityCentipede = (EntityGiantCentipede)par1EntityLivingBase;
    if (par1EntityCentipede.isRiding()) {
  ...
  public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
    EntityGiantCentipede par1EntityCentipede = (EntityGiantCentipede)par7Entity;
    if (par1EntityCentipede.isRiding()) {

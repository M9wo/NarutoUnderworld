...
public class EntityGiantDog extends EntityTameable {
  ...
  public EntityGiantDog(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(4.0F, 4.5F);
  ...
  public boolean attackEntityAsMob(Entity p_70652_1_) {
    ...
    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.weakness.id, 320, 0));

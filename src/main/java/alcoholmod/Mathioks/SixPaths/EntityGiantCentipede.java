...
public class EntityGiantCentipede extends EntityTameable {
  ...
  public EntityGiantCentipede(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(7.5F, 2.0F);
  ...
  public boolean attackEntityAsMob(Entity p_70652_1_) {
    int i = isTamed() ? 4 : 2;
    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.wither.id, 320, 0));
    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.confusion.id, 320, 0));

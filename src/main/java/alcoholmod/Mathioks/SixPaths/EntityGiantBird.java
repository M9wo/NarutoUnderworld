...
public class EntityGiantBird extends EntityTameable {
  ...
  public EntityGiantBird(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(3.0F, 2.0F);
    ...
    this.tasks.addTask(9, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityPlayer.class, 3.0F));
  ...
  public EntityGiantBird(World par1World, EntityLivingBase par2Entity) {
    super(par1World);
  ...
  public boolean attackEntityAsMob(Entity p_70652_1_) {
    int i = isTamed() ? 4 : 2;
    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.harm.id, 320, 0));
    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.blindness.id, 320, 0));

...
public class KikaichuEntity extends EntityTameable {
  ...
  public KikaichuEntity(World par1World) {
    super(par1World);
  ...
  public boolean attackEntityAsMob(Entity par1Entity) {
    ...
    if (par1Entity instanceof EntityPlayer) {
      EntityPlayer owner = (EntityPlayer)par1Entity;
      ExtendedPlayer props = ExtendedPlayer.get(owner);
    ...
    if (getOwner() != null) {
      EntityPlayer owner = (EntityPlayer)getOwner();
      ExtendedPlayer props = ExtendedPlayer.get(owner);
      return par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), 0.0F);
    } 

...
public class EntityCrocodile extends EntityTameable {
  ...
  public EntityCrocodile(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(10.0F, 6.0F);
  ...
  public boolean attackEntityAsMob(Entity p_70652_1_) {
    int i = isTamed() ? 4 : 2;
    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 320, 0));
    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.weakness.id, 160, 0));

...
public class EntitySnake extends EntityTameable {
  ...
  public EntitySnake(World p_i1696_1_) {
    super(p_i1696_1_);
    setSize(15.0F, 3.0F);
  ...
  public boolean attackEntityAsMob(Entity p_70652_1_) {
    int i = isTamed() ? 4 : 2;
    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.poison.id, 320, 2));

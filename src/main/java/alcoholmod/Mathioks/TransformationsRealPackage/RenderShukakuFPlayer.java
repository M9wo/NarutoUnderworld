...
public class RenderShukakuFPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/ShukakuF.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderShukakuFPlayer() {
    super((ModelBase)new ShukakuFModel(), 0.5F);
  ...
  public ShukakuFModel getPlayerModel() {
    return (ShukakuFModel)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ShukakuFModel modelplayer = getPlayerModel();
  }

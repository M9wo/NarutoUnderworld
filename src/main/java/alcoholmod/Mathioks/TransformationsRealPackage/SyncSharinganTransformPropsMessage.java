...
public class SyncSharinganTransformPropsMessage extends AbstractMessage.AbstractClientMessage {
  private NBTTagCompound data2;
  
  public SyncSharinganTransformPropsMessage() {}
  
  public SyncSharinganTransformPropsMessage(EntityPlayer player) {

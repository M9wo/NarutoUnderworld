...
public class SyncTransformServerMessage extends AbstractMessage.AbstractServerMessage {
  private NBTTagCompound data;
  
  public SyncTransformServerMessage() {}
  
  public SyncTransformServerMessage(EntityPlayer player) {

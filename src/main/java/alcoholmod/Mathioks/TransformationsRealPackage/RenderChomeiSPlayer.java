...
public class RenderChomeiSPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/ChomeiS.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderChomeiSPlayer() {

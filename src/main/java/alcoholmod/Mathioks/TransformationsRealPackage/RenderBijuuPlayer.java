...
public class RenderBijuuPlayer extends RendererLivingEntity {
  private static final ResourceLocation[] Shukakus = new ResourceLocation[16];
  
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/BijuuForm.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  private int textureIndex = 15;
  
  public RenderBijuuPlayer() {
  ...
  protected void initLavaTextures() {
    for (int i = 0; i < Shukakus.length; i++)
      Shukakus[i] = new ResourceLocation("tm:textures/entity/BijuuForm" + i + ".png"); 
  }

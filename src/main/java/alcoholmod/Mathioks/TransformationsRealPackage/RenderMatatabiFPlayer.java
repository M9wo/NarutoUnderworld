...
public class RenderMatatabiFPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/MatatabiF.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderMatatabiFPlayer() {

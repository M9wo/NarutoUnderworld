...
public class SyncTransformMessage extends AbstractMessage {
  private boolean data;
  
  public SyncTransformMessage() {}
  
  public SyncTransformMessage(EntityPlayer player) {
  ...
  public void process(EntityPlayer player, Side side) {
    ExtendedPlayer.get(player).setTransformed(this.data, side);
  }

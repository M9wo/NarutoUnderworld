...
public class RenderShukakuPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/Shukaku.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderShukakuPlayer() {
    super((ModelBase)new ModelShukaku(), 0.5F);
  ...
  public ModelShukaku getPlayerModel() {
    return (ModelShukaku)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ModelShukaku modelplayer = getPlayerModel();
  }

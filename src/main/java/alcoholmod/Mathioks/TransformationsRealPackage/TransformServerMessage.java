...
public class TransformServerMessage extends AbstractMessage.AbstractServerMessage {
  private boolean data;
  
  public TransformServerMessage() {}
  
  public TransformServerMessage(EntityPlayer player) {

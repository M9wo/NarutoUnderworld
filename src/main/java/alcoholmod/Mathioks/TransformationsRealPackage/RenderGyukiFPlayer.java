...
public class RenderGyukiFPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/GyukiF.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderGyukiFPlayer() {

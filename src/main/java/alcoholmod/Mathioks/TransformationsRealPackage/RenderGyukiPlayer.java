...
public class RenderGyukiPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/Gyuki.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderGyukiPlayer() {
    super((ModelBase)new ModelGyuki(), 0.5F);
  ...
  public ModelGyuki getPlayerModel() {
    return (ModelGyuki)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ModelGyuki modelplayer = getPlayerModel();
  }

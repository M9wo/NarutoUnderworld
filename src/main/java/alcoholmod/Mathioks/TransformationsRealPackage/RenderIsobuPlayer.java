...
public class RenderIsobuPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/Isobu.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderIsobuPlayer() {
    super((ModelBase)new ModelIsobu(), 0.5F);
  ...
  public ModelIsobu getPlayerModel() {
    return (ModelIsobu)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ModelIsobu modelplayer = getPlayerModel();
  }

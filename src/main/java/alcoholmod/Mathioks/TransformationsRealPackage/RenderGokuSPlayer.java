...
public class RenderGokuSPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/GokuS.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderGokuSPlayer() {

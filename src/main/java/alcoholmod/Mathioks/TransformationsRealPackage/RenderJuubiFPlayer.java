...
public class RenderJuubiFPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/JuubiFModel.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderJuubiFPlayer() {
    super((ModelBase)new JuubiFModel(), 0.5F);
  ...
  public JuubiFModel getPlayerModel() {
    return (JuubiFModel)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    JuubiFModel modelplayer = getPlayerModel();
  }

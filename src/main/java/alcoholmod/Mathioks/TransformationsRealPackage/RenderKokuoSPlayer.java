...
public class RenderKokuoSPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/KokuoS.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderKokuoSPlayer() {
    super((ModelBase)new KokuoFModel(), 0.5F);
  ...
  public KokuoFModel getPlayerModel() {
    return (KokuoFModel)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    KokuoFModel modelplayer = getPlayerModel();
  }

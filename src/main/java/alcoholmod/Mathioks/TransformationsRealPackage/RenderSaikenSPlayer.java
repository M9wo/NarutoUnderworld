...
public class RenderSaikenSPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/SaikenS.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderSaikenSPlayer() {
    super((ModelBase)new SaikenFModel(), 0.5F);
  ...
  public SaikenFModel getPlayerModel() {
    return (SaikenFModel)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    SaikenFModel modelplayer = getPlayerModel();
  }

...
public class RenderBijuu1TailPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/1tailTrans.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderBijuu1TailPlayer() {
    super((ModelBase)new ModelKyuubi1Tail(0.8F), 0.5F);
  ...
  public ModelKyuubi1Tail getPlayerModel() {
    return (ModelKyuubi1Tail)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ModelKyuubi1Tail modelplayer = getPlayerModel();
  }

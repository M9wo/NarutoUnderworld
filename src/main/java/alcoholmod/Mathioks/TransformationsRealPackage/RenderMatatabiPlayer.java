...
public class RenderMatatabiPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/Matatabi.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderMatatabiPlayer() {
    super((ModelBase)new ModelMatatabi(), 0.5F);
  ...
  public ModelMatatabi getPlayerModel() {
    return (ModelMatatabi)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ModelMatatabi modelplayer = getPlayerModel();
  }

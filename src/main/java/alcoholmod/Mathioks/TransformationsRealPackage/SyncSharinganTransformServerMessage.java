...
public class SyncSharinganTransformServerMessage extends AbstractMessage.AbstractServerMessage {
  private NBTTagCompound data2;
  
  public SyncSharinganTransformServerMessage() {}
  
  public SyncSharinganTransformServerMessage(EntityPlayer player) {

...
public class SyncCurseSealTransformServerMessage extends AbstractMessage.AbstractServerMessage {
  private NBTTagCompound data;
  
  public SyncCurseSealTransformServerMessage() {}
  
  public SyncCurseSealTransformServerMessage(EntityPlayer player) {

...
public class RenderShukakuSPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/ShukakuS.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderShukakuSPlayer() {

...
public class RenderChomeiFPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/ChomeiF.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderChomeiFPlayer() {
    super((ModelBase)new ChomeiFModel(), 0.5F);
  ...
  public ChomeiFModel getPlayerModel() {
    return (ChomeiFModel)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ChomeiFModel modelplayer = getPlayerModel();
  }

...
public class RenderJuubiPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/Juubi.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderJuubiPlayer() {
    super((ModelBase)new ModelJuubi(), 0.5F);
  ...
  public ModelJuubi getPlayerModel() {
    return (ModelJuubi)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ModelJuubi modelplayer = getPlayerModel();
  }

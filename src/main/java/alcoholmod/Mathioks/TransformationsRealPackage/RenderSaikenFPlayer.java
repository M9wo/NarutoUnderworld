...
public class RenderSaikenFPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/SaikenF.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderSaikenFPlayer() {

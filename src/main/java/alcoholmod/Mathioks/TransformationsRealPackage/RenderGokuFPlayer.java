...
public class RenderGokuFPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/GokuF.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderGokuFPlayer() {
    super((ModelBase)new GokuFModel(), 0.5F);
  ...
  public GokuFModel getPlayerModel() {
    return (GokuFModel)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    GokuFModel modelplayer = getPlayerModel();
  }

...
import alcoholmod.Mathioks.FinalBijuu.ModelBijuu6Tail;
...
public class RenderBijuu4TailsPlayer extends RendererLivingEntity {
  private static final ResourceLocation[] Shukakus = new ResourceLocation[16];
  
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/BijuuFormori.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  private int textureIndex = 15;
  
  public RenderBijuu4TailsPlayer() {
    super((ModelBase)new ModelBijuu6Tail(), 0.5F);
    this.renderManager = RenderManager.instance;
    initLavaTextures();
  }
  
  protected void initLavaTextures() {
    for (int i = 0; i < Shukakus.length; i++)
      Shukakus[i] = new ResourceLocation("tm:textures/entity/BijuuFormori" + i + ".png"); 
  }
  ...
  protected ResourceLocation getEntityTexture(Entity entity) {
    ...
    return Shukakus[this.textureIndex];
  }
  ...
  public ModelBijuu6Tail getPlayerModel() {
    return (ModelBijuu6Tail)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ModelBijuu6Tail modelplayer = getPlayerModel();
  }

...
public class RenderMatatabiSPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/MatatabiS.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderMatatabiSPlayer() {
    super((ModelBase)new MatatabiFModel(), 0.5F);
  ...
  public MatatabiFModel getPlayerModel() {
    return (MatatabiFModel)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    MatatabiFModel modelplayer = getPlayerModel();
  }

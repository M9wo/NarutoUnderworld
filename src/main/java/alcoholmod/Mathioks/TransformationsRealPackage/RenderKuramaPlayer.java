...
public class RenderKuramaPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/Kurama.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderKuramaPlayer() {
    super((ModelBase)new ModelKyuubi(), 0.5F);
  ...
  public ModelKyuubi getPlayerModel() {
    return (ModelKyuubi)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ModelKyuubi modelplayer = getPlayerModel();
  }

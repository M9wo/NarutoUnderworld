...
public class SyncTransformPropsMessage extends AbstractMessage.AbstractClientMessage {
  private NBTTagCompound data;
  
  public SyncTransformPropsMessage() {}
  
  public SyncTransformPropsMessage(EntityPlayer player) {

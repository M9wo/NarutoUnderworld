...
public class RenderChomeiPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/Chomei.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderChomeiPlayer() {
    super((ModelBase)new ModelChomei(), 0.5F);
  ...
  public ModelChomei getPlayerModel() {
    return (ModelChomei)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ModelChomei modelplayer = getPlayerModel();
  }

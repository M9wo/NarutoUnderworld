...
public class RenderSaikenPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/Seiken.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderSaikenPlayer() {
    super((ModelBase)new ModelSaiken(), 0.5F);
  ...
  public ModelSaiken getPlayerModel() {
    return (ModelSaiken)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ModelSaiken modelplayer = getPlayerModel();
  }

...
public class RenderSonGokuPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/SonGoku.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderSonGokuPlayer() {
    super((ModelBase)new ModelSonGoku(), 0.5F);
  ...
  public ModelSonGoku getPlayerModel() {
    return (ModelSonGoku)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    ModelSonGoku modelplayer = getPlayerModel();
  }

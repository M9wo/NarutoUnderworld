...
public class RenderJuubiSPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/JuubiSModel.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderJuubiSPlayer() {
    super((ModelBase)new JuubiSModel(), 0.5F);
  ...
  public JuubiSModel getPlayerModel() {
    return (JuubiSModel)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    JuubiSModel modelplayer = getPlayerModel();
  }

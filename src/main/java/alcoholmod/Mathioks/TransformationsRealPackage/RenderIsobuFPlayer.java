...
public class RenderIsobuFPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/IsobuF.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderIsobuFPlayer() {
    super((ModelBase)new IsobuFModel(), 0.5F);
  ...
  public IsobuFModel getPlayerModel() {
    return (IsobuFModel)this.mainModel;
  }
  ...
  private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
    IsobuFModel modelplayer = getPlayerModel();
  }

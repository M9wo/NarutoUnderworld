...
public class RenderKokuoFPlayer extends RendererLivingEntity {
  private static final ResourceLocation Shukaku = new ResourceLocation("tm:textures/entity/KokuoF.png");
  
  private static Minecraft mc = Minecraft.getMinecraft();
  
  public RenderKokuoFPlayer() {

...
public class KillerB extends EntityMob implements IBossDisplayData {
  Random rand = new Random();
  
  public KillerB(World par1World) {
    super(par1World);
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(6500.0D);
  ...
  public void onUpdate() {
    ...
    if (this.rand.nextInt(100) == 0 && !this.worldObj.isRemote) {
      ...
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.harm.id, 40, 6));
    } 
  }

...
public class JinshurikiFu extends EntityMob implements IBossDisplayData {
  Random rand = new Random();
  
  public JinshurikiFu(World par1World) {
    super(par1World);
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(3500.0D);
  ...
  public void onUpdate() {
    ...
    if (this.rand.nextInt(100) == 0 && !this.worldObj.isRemote) {
      ...
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 200, 3));
    } 
  }

...
public class JinshurikiHan extends EntityMob implements IBossDisplayData {
  Random rand = new Random();
  
  public JinshurikiHan(World par1World) {
    super(par1World);
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(5500.0D);

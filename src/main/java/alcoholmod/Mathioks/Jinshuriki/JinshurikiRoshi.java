...
public class JinshurikiRoshi extends EntityMob implements IBossDisplayData {
  Random rand = new Random();
  
  public JinshurikiRoshi(World par1World) {
    super(par1World);
  ...
  protected void applyEntityAttributes() {
    ...
    getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(6600.0D);
  ...
  public void onUpdate() {
    ...
    if (this.rand.nextInt(100) == 0 && !this.worldObj.isRemote) {
      ...
      this.attackingPlayer.setFire(20);
    } 
  }

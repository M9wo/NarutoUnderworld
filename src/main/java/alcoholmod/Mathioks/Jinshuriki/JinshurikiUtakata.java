...
public class JinshurikiUtakata extends EntityMob implements IBossDisplayData {
  Random rand = new Random();
  
  public JinshurikiUtakata(World par1World) {
    super(par1World);
  ...
  public void onUpdate() {
    ...
    if (this.rand.nextInt(100) == 0 && !this.worldObj.isRemote) {
      ...
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.poison.id, 100, 10));
      this.attackingPlayer.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 100, 4));
    } 
  }

...
public class EntitySusanoo3 extends EntityLiving {
  public EntityLivingBase jutsusha;
  
  public final float scale = 4.0F;
  
  public EntitySusanoo3(World par1World) {
    super(par1World);
    this.ignoreFrustumCheck = true;
    this.isImmuneToFire = true;
  }
  
  public EntitySusanoo3(World par1World, EntityLivingBase par2Entity) {
    super(par1World);

...
public class SyncChakraControlMessage extends AbstractMessage {
  private boolean data;
  
  public SyncChakraControlMessage() {}
  
  public SyncChakraControlMessage(EntityPlayer player) {
  ...
  public void process(EntityPlayer player, Side side) {
    ExtendedPlayer.get(player).setChakraControl(this.data, side);
  }

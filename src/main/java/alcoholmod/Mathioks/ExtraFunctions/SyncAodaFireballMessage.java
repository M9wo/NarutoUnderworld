...
public class SyncAodaFireballMessage extends AbstractMessage {
  private boolean data;
  
  public SyncAodaFireballMessage() {}
  
  public SyncAodaFireballMessage(boolean data, EntityPlayer player) {

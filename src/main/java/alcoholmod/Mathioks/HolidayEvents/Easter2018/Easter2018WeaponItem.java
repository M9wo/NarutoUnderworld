...
public class Easter2018WeaponItem extends ItemSword {
  public Easter2018WeaponItem(Item.ToolMaterial mat) {
    super(mat);
    setFull3D();
    setUnlocalizedName("eastersword");
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    par3List.add(EnumChatFormatting.DARK_AQUA + "A blade used by the easter bunny's");
    par3List.add(EnumChatFormatting.DARK_AQUA + "personal shinobi, Kurousagi");

...
public class Easter2018EasterEggRed extends Item {
      ...
      if (EmptySpaces > 0) {
        ...
        if (calendar.get(2) + 1 == 3 && calendar.get(5) >= 30) {
          if (Par1ItemStack.stackTagCompound.getInteger("Obtained") == 1) {
            ...
            if (rand == 20) {
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.Easter2018Ninjutsu));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You open the Easter Egg..."));
              ...
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.GOLD + "Ninjutsu: Unoeuf!"));
            } 
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    par3List.add(EnumChatFormatting.RED + "A Red Easter Egg...");
    par3List.add(EnumChatFormatting.RED + "Right click it to find out what's inside!");

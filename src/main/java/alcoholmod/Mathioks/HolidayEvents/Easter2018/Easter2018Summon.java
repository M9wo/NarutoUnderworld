...
public class Easter2018Summon extends JutsuItem {
  public Easter2018Summon() {
    setMaxDamage(10002);
    isDamageable();
    this.maxStackSize = 1;
  }
  ...
  public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5) {
    ...
    if (start) {
      ...
      if (counter >= 55 && counter <= 65) {
        KurousagiEntity fireball2 = new KurousagiEntity(par2World);
          ...
          if (props.getCurrentMana() >= 50) {
            if (Par1ItemStack.stackTagCompound.getInteger("Obtained") == 1)
              if (Par1ItemStack.getItemDamage() == 0) {
                ...
                Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("Summoning : Kurousagi!!!"));
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    ...
    par3List.add(EnumChatFormatting.DARK_AQUA + "with the Easter Bunnies right hand shinobi,");
    par3List.add(EnumChatFormatting.DARK_AQUA + "and Miori's signature summon, Kurousagi!");
    par3List.add(EnumChatFormatting.YELLOW + "Needed Summoning: 45");

...
public class Easter2018EasterEggBlue extends Item {
      ...
      if (EmptySpaces > 0) {
        ...
        if (calendar.get(2) + 1 == 3 && calendar.get(5) >= 30) {
          if (Par1ItemStack.stackTagCompound.getInteger("Obtained") == 1) {
            ...
            if (rand == 20) {
              Par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(AlcoholMod.helmetEaster));
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText("You open the Easter Egg..."));
              ...
              Par3EntityPlayer.addChatComponentMessage((IChatComponent)new ChatComponentText(EnumChatFormatting.GOLD + "Hidden Egg Village Headband!"));
            } 
  ...
  public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
    par3List.add(EnumChatFormatting.BLUE + "A Blue Easter Egg...");
    par3List.add(EnumChatFormatting.BLUE + "Right click it to find out what's inside!");

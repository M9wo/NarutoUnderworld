...
public class EntityUltimateSusanoo extends EntityLiving {
  public EntityLivingBase jutsusha;
  
  private boolean disableDamage;
  
  public EntityUltimateSusanoo(World par1World) {
    super(par1World);
  ...
  public EntityUltimateSusanoo(World par1World, EntityLivingBase par2Entity) {
    super(par1World);

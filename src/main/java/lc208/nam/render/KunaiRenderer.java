...
public class KunaiRenderer extends RenderEntity {
  private static final ResourceLocation texture = new ResourceLocation("am:textures/entity/kunaitexture.png");
  
  private static final ResourceLocation shuriken = new ResourceLocation("am:textures/entity/kunai.obj");
  ...
  public void doRender(Entity entity, double v, double v1, double v2, float v3, float v4) {
    render((KunaiEntity)entity, v, v1, v2, v3, v4);
  }
  
  public void render(KunaiEntity par1EntityArrow, double par2, double par4, double par6, float par8, float par9) {
    bindTexture(texture);
    GL11.glPushMatrix();

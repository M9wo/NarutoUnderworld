...
public class NewEntitySusanoo extends EntityLiving {
  public EntityLivingBase jutsusha;
  
  private boolean disableDamage;
  
  public NewEntitySusanoo(World par1World) {
    super(par1World);
  ...
  public NewEntitySusanoo(World par1World, EntityLivingBase par2Entity) {
    super(par1World);

...
public class EntitySusanooStage0 extends EntityLiving {
  public EntityLivingBase jutsusha;
  
  public EntitySusanooStage0(World par1World) {
    super(par1World);
  ...
  public EntitySusanooStage0(World par1World, EntityLivingBase par2Entity) {
    super(par1World);
  ...
  public void onUpdate() {
    ...
    super.onUpdate();
    if (!this.worldObj.isRemote && (this.jutsusha == null || Keyboard.isKeyDown(181) || this.ticksExisted >= 600))
      setDead(); 
